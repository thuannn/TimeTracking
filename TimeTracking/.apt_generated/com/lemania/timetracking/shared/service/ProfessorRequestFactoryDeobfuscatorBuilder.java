...
withOperation(new OperationKey("BOpvP4Molsxs_uC9xiPbDEYeJZw="),
  ...
  .withRequestContext("com.lemania.timetracking.shared.service.ProfessorRequestFactory$ProfessorRequestContext")
  .build());
withOperation(new OperationKey("Cx$tchtAbIy8mQ_KNHsB2Ac9vBk="),
  new OperationData.Builder()
  .withClientMethodDescriptor("(Ljava/lang/String;Lcom/lemania/timetracking/shared/ProfessorProxy;)Lcom/google/web/bindery/requestfactory/shared/Request;")
  .withDomainMethodDescriptor("(Ljava/lang/String;Lcom/lemania/timetracking/server/Professor;)Lcom/lemania/timetracking/server/Cours;")
  .withMethodName("addCourse")
  .withRequestContext("com.lemania.timetracking.shared.service.ProfessorRequestFactory$ProfessorRequestContext")
  .build());
