...
// com.lemania.timetracking.shared.service.UserRequestFactory
...
withOperation(new OperationKey("vMEVxvBL$fsBBnk3LEJqQbw7ypU="),
  ...
  .build());
withOperation(new OperationKey("4kFsW5EpQ5A3QVDZhQI24vu1LRA="),
  new OperationData.Builder()
  .withClientMethodDescriptor("(Lcom/lemania/timetracking/shared/UserProxy;Ljava/lang/String;)Lcom/google/web/bindery/requestfactory/shared/Request;")
  .withDomainMethodDescriptor("(Lcom/lemania/timetracking/server/User;Ljava/lang/String;)Ljava/util/List;")
...
withRawTypeToken("xkktZ4bhcx2gajD5uxoicWtJ63A=", "com.lemania.timetracking.shared.UserProxy");
...
withClientToDomainMappings("com.lemania.timetracking.server.User", Arrays.asList("com.lemania.timetracking.shared.UserProxy"));
}}
