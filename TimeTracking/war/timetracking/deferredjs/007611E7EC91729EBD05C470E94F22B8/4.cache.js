...
defineSeed(882, 695, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(883, 634, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(884, 634, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(885, 634, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1043, 700, makeCastMap([Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1152, 638, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
