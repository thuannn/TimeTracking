...
defineSeed(872, 695, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$RptTimeByMonthPresenter, Q$RptTimeByMonthUiHandler]), RptTimeByMonthPresenter_0);
...
defineSeed(873, 634, makeCastMap([Q$Receiver]), RptTimeByMonthPresenter$1_0);
...
defineSeed(1020, 700, makeCastMap([Q$RptTimeByMonthPresenter$MyView]), RptTimeByMonthView_0);
...
defineSeed(1131, 638, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$7X_0);
