...
defineSeed(865, 695, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$RptTimeByDepartmentPresenter, Q$RptTimeByDepartmentUiHandler]), RptTimeByDepartmentPresenter_0);
...
defineSeed(866, 634, makeCastMap([Q$Receiver]), RptTimeByDepartmentPresenter$1_0);
...
defineSeed(867, 634, makeCastMap([Q$Receiver]), RptTimeByDepartmentPresenter$2_0);
...
defineSeed(1015, 700, makeCastMap([Q$RptTimeByDepartmentPresenter$MyView, Q$RptTimeByDepartmentView]), RptTimeByDepartmentView_0);
...
defineSeed(1145, 638, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$4X_0);
