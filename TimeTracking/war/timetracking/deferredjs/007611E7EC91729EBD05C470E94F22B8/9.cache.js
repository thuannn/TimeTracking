...
defineSeed(744, 221, {}, EcoleAddedEvent_0);
...
defineSeed(783, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(802, 695, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$EcoleAddUiHandler]), EcoleAddPresenter_0);
...
defineSeed(803, 634, makeCastMap([Q$Receiver]), EcoleAddPresenter$1_0);
...
;
defineSeed(809, 723, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$Place, Q$EcoleAddedEvent$EcoleAddedHandler]));
...
defineSeed(810, 707, {}, EcolePresenterMyProxyImpl$1_0);
...
defineSeed(811, 1, {}, EcolePresenterMyProxyImpl$1$1_0);
...
defineSeed(931, 700, makeCastMap([Q$EcoleAddPresenter$MyView]), EcoleAddView_0);
...
defineSeed(1089, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$EcoleProxy]));
...
;
defineSeed(1090, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$EcoleProxy]));
...
defineSeed(1121, 638, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$5X_0);
...
;
_.val$ecole = null;
var Lcom_lemania_timetracking_client_presenter_EcoleAddPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcoleAddPresenter', 802), Lcom_lemania_timetracking_client_presenter_EcoleAddPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcoleAddPresenter$1', 803), Lcom_lemania_timetracking_client_event_EcoleAddedEvent_2_classLit = createForClass('com.lemania.timetracking.client.event.', 'EcoleAddedEvent', 744), Lcom_lemania_timetracking_client_view_EcoleAddView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView', 931), Lcom_lemania_timetracking_client_presenter_EcolePresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcolePresenterMyProxyImpl$1', 810), Lcom_lemania_timetracking_client_presenter_EcolePresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcolePresenterMyProxyImpl$1$1', 811), Lcom_lemania_timetracking_shared_service_EcoleRequestFactory_1EcoleRequestContextImpl$5X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'EcoleRequestFactory_EcoleRequestContextImpl$5X', 1121), Lcom_lemania_timetracking_client_view_EcoleAddView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView_BinderImpl', 932), Lcom_lemania_timetracking_client_view_EcoleAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView_BinderImpl$Widgets', 933), Lcom_lemania_timetracking_client_view_EcoleAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView_BinderImpl$Widgets$1', 934), Lcom_lemania_timetracking_client_view_EcoleAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView_BinderImpl$Widgets$2', 935);
$entry(onLoad)(9);
