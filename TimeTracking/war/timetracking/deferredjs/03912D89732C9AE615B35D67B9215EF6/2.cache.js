...
defineSeed(743, 227, {}, CoursAddedEvent_0);
...
defineSeed(756, 692, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(757, 631, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(758, 631, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(766, 721, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$Place, Q$CoursAddedEvent$CoursAddedHandler]));
...
defineSeed(767, 705, {}, CoursPresenterMyProxyImpl$1_0);
...
defineSeed(920, 697, makeCastMap([Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(1119, 635, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
