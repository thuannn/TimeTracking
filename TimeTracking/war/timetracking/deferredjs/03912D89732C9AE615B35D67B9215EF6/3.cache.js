...
defineSeed(761, 692, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(762, 631, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(763, 631, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(764, 631, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(765, 631, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(926, 697, makeCastMap([Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1120, 635, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
