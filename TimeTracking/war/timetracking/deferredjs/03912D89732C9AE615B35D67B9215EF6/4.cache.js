...
defineSeed(744, 227, {}, EcoleAddedEvent_0);
...
defineSeed(770, 692, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$EcoleAddUiHandler]), EcoleAddPresenter_0);
...
defineSeed(771, 631, makeCastMap([Q$Receiver]), EcoleAddPresenter$1_0);
...
;
_.this$0 = null;
defineSeed(777, 721, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$Place, Q$EcoleAddedEvent$EcoleAddedHandler]));
...
defineSeed(778, 705, {}, EcolePresenterMyProxyImpl$1_0);
...
defineSeed(779, 1, {}, EcolePresenterMyProxyImpl$1$1_0);
...
defineSeed(935, 697, makeCastMap([Q$EcoleAddPresenter$MyView]), EcoleAddView_0);
...
defineSeed(1126, 635, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$5X_0);
