...
function $createAndBindUi_1(owner){
  ...
  $setHTML(f_Button11, (sb_0 = new StringBuilder_0 , $append_2(sb_0.data, 'Afiner') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb_0.data))).html);
  $setInnerText(f_Button11.element, 'Filtrer');
  $add_6(f_HorizontalPanel5, f_Button11);
  $add_8(f_VerticalPanel3, f_HorizontalPanel5);
  $setHTML(f_Button12, (sb_1 = new StringBuilder_0 , $append_2(sb_1.data, 'Extraire en Excel') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb_1.data))).html);
