...
_.onReset = function onReset_7(){
  var rc, rf, rcl, rfl, x;
  $initializeValues(dynamicCast(this.view, Q$TimeInputPresenter$MyView));
...
_.success = function success_6(presenter){
  $success_4(this, dynamicCast(presenter, Q$TimeInputPresenter));
}
;
_.val$event = null;
...
function $initializeValues(this$static){
  var i;
  ...
  for (i = 2012; i < 2015; ++i)
    $insertItem(this$static.lstYear, '' + i, '' + i, -1);
}
...
function $save_1(this$static, log){
  var x;
  x = new LogRequestFactory_LogRequestContextImpl$6X_0(this$static, log);
  $addInvocation(this$static.state.dialect, x);
  return x;
}
...
_.val$profId = null;
_.val$year = null;
function LogRequestFactory_LogRequestContextImpl$6X_0(this$0, val$log){
