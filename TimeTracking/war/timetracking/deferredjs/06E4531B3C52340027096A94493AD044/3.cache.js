...
function $initializeUi_0(this$static){
  ...
  this$static.cmdAdd.element['disabled'] = !true;
}
...
function $createAndBindUi_4(owner){
  ...
  $setValue(chkProfStatus, ($clinit_Boolean() , $clinit_Boolean() , TRUE));
