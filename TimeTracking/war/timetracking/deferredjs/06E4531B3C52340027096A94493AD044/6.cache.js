...
function $get_Key$type$com$lemania$timetracking$client$presenter$ProfsPresenter$_annotation$$none$$(this$static){
  var result;
  !this$static.singleton_Key$type$com$lemania$timetracking$client$presenter$ProfsPresenter$_annotation$$none$$ && (this$static.singleton_Key$type$com$lemania$timetracking$client$presenter$ProfsPresenter$_annotation$$none$$ = (result = $com$lemania$timetracking$client$presenter$ProfsPresenter_ProfsPresenter_methodInjection((!this$static.singleton_Key$type$com$google$web$bindery$event$shared$EventBus$_annotation$$none$$ && (this$static.singleton_Key$type$com$google$web$bindery$event$shared$EventBus$_annotation$$none$$ = new SimpleEventBus_0) , this$static.singleton_Key$type$com$google$web$bindery$event$shared$EventBus$_annotation$$none$$), (!this$static.singleton_Key$type$com$lemania$timetracking$client$view$ProfsView$_annotation$$none$$ && (this$static.singleton_Key$type$com$lemania$timetracking$client$view$ProfsView$_annotation$$none$$ = new ProfsView_0(new ProfsView_BinderImpl_0)) , this$static.singleton_Key$type$com$lemania$timetracking$client$view$ProfsView$_annotation$$none$$), !this$static.singleton_Key$type$com$lemania$timetracking$client$presenter$ProfsPresenter$MyProxy$_annotation$$none$$ && (this$static.singleton_Key$type$com$lemania$timetracking$client$presenter$ProfsPresenter$MyProxy$_annotation$$none$$ = new ProfsPresenterMyProxyImpl_0)) , $com$gwtplatform$mvp$client$HandlerContainerImpl_automaticBind_methodInjection_______(result, (!this$static.singleton_Key$type$com$gwtplatform$mvp$client$AutobindDisable$_annotation$$none$$ && (this$static.singleton_Key$type$com$gwtplatform$mvp$client$AutobindDisable$_annotation$$none$$ = new AutobindDisable_0) , this$static.singleton_Key$type$com$gwtplatform$mvp$client$AutobindDisable$_annotation$$none$$)) , result));
...
function $updateProfessorStatus(this$static, prof, status_0){
  ...
  $fire((x = new ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0(rc, profForUpdate) , $addInvocation(rc.state.dialect, x) , x), new ProfsPresenter$4_0(this$static));
}
...
_.onReset = function onReset_6(){
  var rc, rf, x, crc, crf, rc_0, rf_0;
  rf = new ProfessorRequestFactoryImpl_0;
  $initialize_0(rf, this.eventBus, new DefaultRequestTransport_0);
  rc = new ProfessorRequestFactory_ProfessorRequestContextImpl_0(rf);
  $fire((x = new ProfessorRequestFactory_ProfessorRequestContextImpl$1X_0(rc) , $addInvocation(rc.state.dialect, x) , x), new ProfsPresenter$1_0(this));
  rf_0 = new EcoleRequestFactoryImpl_0;
  $initialize_0(rf_0, this.eventBus, new DefaultRequestTransport_0);
  rc_0 = new EcoleRequestFactory_EcoleRequestContextImpl_0(rf_0);
  $fire($listAllActive(rc_0), new ProfsPresenter$2_0(this));
  crf = new CoursRequestFactoryImpl_0;
  $initialize_0(crf, this.eventBus, new DefaultRequestTransport_0);
  crc = new CoursRequestFactory_CoursRequestContextImpl_0(crf);
  $fire($listAll_0(crc, ''), new ProfsPresenter$3_0(this));
}
;
...
_.onSuccess_0 = function onSuccess_31(response){
  $onSuccess_18(this, dynamicCast(response, Q$ProfessorProxy));
}
;
_.castableTypeMap$ = makeCastMap([Q$Receiver]);
_.this$0 = null;
...
_.onSuccess_0 = function onSuccess_33(response){
  $onSuccess_20(this, dynamicCast(response, Q$AssignmentProxy));
}
;
_.castableTypeMap$ = makeCastMap([Q$Receiver]);
_.this$0 = null;
...
function ProfsPresenter$7(){
}

_ = ProfsPresenter$7_0.prototype = ProfsPresenter$7.prototype = new Receiver;
_.getClass$ = function getClass_585(){
  return Lcom_lemania_timetracking_client_presenter_ProfsPresenter$7_2_classLit;
}
;
...
;
_.getValue = function getValue_16(ecole){
...
_.onSelectionChange = function onSelectionChange_0(event_0){
  ...
  if (this.this$0.selectedProfessor) {
    ...
    $setText(this.this$0.lblProfNameAssign, this.this$0.selectedProfessor.getProfName());
...
function $createAndBindUi_5(owner){
  var attachRecord0, cmdAddCourse, domId0, domId0Element, f_FlowPanel12, f_Grid7, f_HTMLPanel1, f_HorizontalPanel13, f_HorizontalPanel4, f_Label10, f_Label11, f_Label14, f_Label3, f_Label8, f_Label9, f_VerticalPanel2, f_VerticalPanel5, f_VerticalPanel6, handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2, lblProfName, lblProfNameAssign, lstAddCourse, lstAddEcole, pager, tblAssignment, tblProfessors, sb, sb_0;
  ...
  $setTextOrHtml(f_Label8.directionalTextHelper, 'Assigner un cours pour :');
  $updateHorizontalAlignment(f_Label8);
  f_Label8.element.style['width'] = '';
  ...
  $setHTML(cmdAddCourse, (sb_0 = new StringBuilder_0 , $append_2(sb_0.data, 'Ajouter') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb_0.data))).html);
  $resizeColumns(f_Grid7);
  $resizeRows(f_Grid7, 4);
  $setWidget_1(f_Grid7, 0, 0, f_Label8);
  $setWidget_1(f_Grid7, 0, 1, lblProfNameAssign);
  $setWidget_1(f_Grid7, 1, 0, f_Label9);
  $setWidget_1(f_Grid7, 1, 1, lstAddEcole);
  $setWidget_1(f_Grid7, 2, 0, f_Label10);
  $setWidget_1(f_Grid7, 2, 1, lstAddCourse);
  $setWidget_1(f_Grid7, 3, 0, f_Label11);
  $setWidget_1(f_Grid7, 3, 1, cmdAddCourse);
  f_Grid7.element['className'] = 'sideBar';
  f_Grid7.element.style['width'] = '100%';
  $add_8(f_VerticalPanel6, f_Grid7);
  f_FlowPanel12.element.style['height'] = '20px';
  $add_8(f_VerticalPanel6, f_FlowPanel12);
  $setTextOrHtml(f_Label14.directionalTextHelper, 'Liste des courses pris en charge :');
  $updateHorizontalAlignment(f_Label14);
  $add_6(f_HorizontalPanel13, f_Label14);
  $add_6(f_HorizontalPanel13, lblProfName);
  f_HorizontalPanel13.element.style['height'] = '20px';
  f_HorizontalPanel13.element.style['width'] = '100%';
  $add_8(f_VerticalPanel6, f_HorizontalPanel13);
...
function $listAll(this$static, profId){
  var x;
  x = new AssignmentRequestFactory_AssignmentRequestContextImpl$2X_0(this$static, profId);
...
function $saveAndReturn(this$static, courseId, profId){
  var x;
  x = new AssignmentRequestFactory_AssignmentRequestContextImpl$7X_0(this$static, courseId, profId);
  $addInvocation(this$static.state.dialect, x);
  return x;
}
...
var FACTORY_0 = null;
function AssignmentRequestFactory_AssignmentRequestContextImpl$2X_0(this$0, val$profId){
  this.val$profId = val$profId;
  AbstractRequest_0.call(this, this$0);
}

function AssignmentRequestFactory_AssignmentRequestContextImpl$2X(){
}

_ = AssignmentRequestFactory_AssignmentRequestContextImpl$2X_0.prototype = AssignmentRequestFactory_AssignmentRequestContextImpl$2X.prototype = new AbstractRequest;
_.getClass$ = function getClass_736(){
  return Lcom_lemania_timetracking_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$2X_2_classLit;
}
;
...
_.val$profId = null;
function AssignmentRequestFactory_AssignmentRequestContextImpl$7X_0(this$0, val$courseId, val$profId){
  this.val$courseId = val$courseId;
  this.val$profId = val$profId;
  AbstractRequest_0.call(this, this$0);
}

function AssignmentRequestFactory_AssignmentRequestContextImpl$7X(){
}

_ = AssignmentRequestFactory_AssignmentRequestContextImpl$7X_0.prototype = AssignmentRequestFactory_AssignmentRequestContextImpl$7X.prototype = new AbstractRequest;
_.getClass$ = function getClass_737(){
  return Lcom_lemania_timetracking_shared_service_AssignmentRequestFactory_1AssignmentRequestContextImpl$7X_2_classLit;
}
;
...
function ProfessorRequestFactory_ProfessorRequestContextImpl$1X_0(this$0){
  AbstractRequest_0.call(this, this$0);
}

function ProfessorRequestFactory_ProfessorRequestContextImpl$1X(){
}

_ = ProfessorRequestFactory_ProfessorRequestContextImpl$1X_0.prototype = ProfessorRequestFactory_ProfessorRequestContextImpl$1X.prototype = new AbstractRequest;
_.getClass$ = function getClass_768(){
  return Lcom_lemania_timetracking_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$1X_2_classLit;
}
;
