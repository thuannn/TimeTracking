...
function $createAndBindUi_2(owner){
  var attachRecord0, cmdLogin, domId0, domId0Element, f_HTMLPanel1, f_HorizontalPanel4, f_Image8, f_Label3, f_Label5, f_Label6, f_Label7, f_VerticalPanel2, handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2, panelLogin, txtPassword, txtUserName, sb;
  ...
  $setHorizontalAlignment_0(f_HorizontalPanel4, ALIGN_LEFT);
  $setTextOrHtml(f_Label5.directionalTextHelper, "Nom d'utilisateur :");
  $updateHorizontalAlignment(f_Label5);
  $setTextOrHtml(f_Label6.directionalTextHelper, 'Mot de passe :');
  ...
  $setWidget_1(panelLogin, 0, 0, f_Label5);
  $setWidget_1(panelLogin, 0, 1, txtUserName);
  $setWidget_1(panelLogin, 1, 0, f_Label6);
  $setWidget_1(panelLogin, 1, 1, txtPassword);
  $setWidget_1(panelLogin, 2, 0, f_Label7);
  $setWidget_1(panelLogin, 2, 1, cmdLogin);
  panelLogin.element.style['width'] = '';
  $add_6(f_HorizontalPanel4, panelLogin);
  $add_8(f_VerticalPanel2, f_HorizontalPanel4);
  f_Image8.element.style['height'] = '336px';
  f_Image8.element.style['width'] = '339px';
  $setUrl(f_Image8, ($clinit_UriUtils() , new SafeUriString_0('images/Capture.PNG')));
  $add_8(f_VerticalPanel2, f_Image8);
  ...
  $addDomHandler(txtPassword, handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, ($clinit_KeyPressEvent() , $clinit_KeyPressEvent() , TYPE_1));
