...
defineSeed(788, 693, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$FrmPasswordPresenter, Q$FrmPasswordUiHandler]), FrmPasswordPresenter_0);
...
defineSeed(789, 629, makeCastMap([Q$Receiver]), FrmPasswordPresenter$1_0);
...
function FrmPasswordView_0(){
  this.widget = $build_f_HTMLPanel1_5(new FrmPasswordView_BinderImpl$Widgets_0(this));
}

defineSeed(984, 698, makeCastMap([Q$IsWidget, Q$FrmPasswordPresenter$MyView]), FrmPasswordView_0);
...
defineSeed(985, 1, {}, FrmPasswordView_BinderImpl_0);
function $build_f_HTMLPanel1_5(this$static){
  ...
  attachRecord6 = attachToDom(($clinit_DOM() , f_HTMLPanel1.element));
...
defineSeed(986, 1, {}, FrmPasswordView_BinderImpl$Widgets_0);
function FrmPasswordView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(987, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), FrmPasswordView_BinderImpl$Widgets$1_0);
...
function $changePassword_0(this$static, userName, password, newPassword){
  var x_0;
  x_0 = new UserRequestFactory_UserRequestContextImpl$3X_0(this$static, userName, password, newPassword);
...
defineSeed(1237, 633, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$3X_0);
...
;
var Lcom_lemania_timetracking_client_presenter_FrmPasswordPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'FrmPasswordPresenter', 788), Lcom_lemania_timetracking_client_presenter_FrmPasswordPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'FrmPasswordPresenter$1', 789), Lcom_lemania_timetracking_client_view_FrmPasswordView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'FrmPasswordView', 984), Lcom_lemania_timetracking_client_view_FrmPasswordView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'FrmPasswordView_BinderImpl', 985), Lcom_lemania_timetracking_client_view_FrmPasswordView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'FrmPasswordView_BinderImpl$Widgets', 986), Lcom_lemania_timetracking_client_view_FrmPasswordView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'FrmPasswordView_BinderImpl$Widgets$1', 987), Lcom_lemania_timetracking_shared_service_UserRequestFactory_1UserRequestContextImpl$3X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'UserRequestFactory_UserRequestContextImpl$3X', 1237);
$entry(onLoad)(7);
