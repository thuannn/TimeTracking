...
defineSeed(843, 672, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(844, 611, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(845, 611, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(846, 611, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1048, 677, makeCastMap([Q$IsWidget, Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1155, 615, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
