...
defineSeed(826, 672, makeCastMap([Q$HasHandlers, Q$PresenterWidget]), RptTimeBySchoolPresenter_0);
...
defineSeed(827, 611, makeCastMap([Q$Receiver]), RptTimeBySchoolPresenter$1_0);
...
defineSeed(1008, 677, makeCastMap([Q$RptTimeBySchoolPresenter$MyView, Q$RptTimeBySchoolView]), RptTimeBySchoolView_0);
...
defineSeed(1009, 380, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$1_0);
...
defineSeed(1010, 380, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$10_0);
...
defineSeed(1011, 380, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$11_0);
...
defineSeed(1012, 380, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$12_0);
...
defineSeed(1013, 380, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$13_0);
...
defineSeed(1014, 380, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$2_0);
...
defineSeed(1015, 380, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$3_0);
...
defineSeed(1016, 380, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$4_0);
...
defineSeed(1017, 380, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$5_0);
...
defineSeed(1018, 380, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$6_0);
...
defineSeed(1019, 380, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$7_0);
...
defineSeed(1020, 380, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$8_0);
...
defineSeed(1021, 380, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$9_0);
