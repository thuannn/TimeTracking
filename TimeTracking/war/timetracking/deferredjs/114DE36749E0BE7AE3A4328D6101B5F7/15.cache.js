...
defineSeed(725, 233, {}, LogTypeAddedEvent_0);
...
defineSeed(776, 672, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$HourAddUiHandler]), LogTypesAddPresenter_0);
...
defineSeed(777, 611, makeCastMap([Q$Receiver]), LogTypesAddPresenter$1_0);
...
;
_.this$0 = null;
defineSeed(785, 701, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$Place, Q$LogTypeAddedEvent$LogTypeAddedHandler]));
...
defineSeed(786, 685, {}, LogTypesPresenterMyProxyImpl$1_0);
...
defineSeed(787, 1, {}, LogTypesPresenterMyProxyImpl$1$1_0);
...
defineSeed(941, 677, makeCastMap([Q$LogTypesAddPresenter$MyView]), LogTypesAddView_0);
...
defineSeed(1114, 615, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$5X_0);
