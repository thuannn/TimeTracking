...
defineSeed(780, 672, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LogTypeAddedEvent$LogTypeAddedHandler, Q$LogTypesPresenter, Q$LogTypeListUiHandler]), LogTypesPresenter_0);
...
defineSeed(781, 611, makeCastMap([Q$Receiver]), LogTypesPresenter$1_0);
...
defineSeed(782, 611, makeCastMap([Q$Receiver]), LogTypesPresenter$2_0);
...
defineSeed(783, 611, makeCastMap([Q$Receiver]), LogTypesPresenter$3_0);
...
defineSeed(784, 611, makeCastMap([Q$Receiver]), LogTypesPresenter$4_0);
...
defineSeed(947, 677, makeCastMap([Q$LogTypesPresenter$MyView]), LogTypesView_0);
...
defineSeed(1113, 615, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$2X_0);
...
defineSeed(1115, 615, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$6X_0);
