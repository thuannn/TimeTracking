...
defineSeed(724, 233, {}, EcoleAddedEvent_0);
...
defineSeed(750, 672, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$EcoleAddUiHandler]), EcoleAddPresenter_0);
...
defineSeed(751, 611, makeCastMap([Q$Receiver]), EcoleAddPresenter$1_0);
...
;
_.this$0 = null;
defineSeed(757, 701, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$Place, Q$EcoleAddedEvent$EcoleAddedHandler]));
...
defineSeed(758, 685, {}, EcolePresenterMyProxyImpl$1_0);
...
defineSeed(759, 1, {}, EcolePresenterMyProxyImpl$1$1_0);
...
defineSeed(914, 677, makeCastMap([Q$EcoleAddPresenter$MyView]), EcoleAddView_0);
...
defineSeed(1099, 615, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$5X_0);
