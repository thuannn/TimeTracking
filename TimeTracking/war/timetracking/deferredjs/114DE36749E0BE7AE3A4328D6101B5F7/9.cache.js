...
defineSeed(801, 672, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(802, 611, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(803, 611, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(804, 611, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(805, 611, makeCastMap([Q$Receiver]), ProfsPresenter$4_0);
...
defineSeed(806, 611, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(807, 611, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(808, 611, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(984, 677, makeCastMap([Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1060, 572, makeCastMap([Q$AutoBean, Q$AbstractAutoBean, Q$HasSplittable]), AssignmentProxyAutoBean_com_google_web_bindery_requestfactory_shared_impl_EntityProxyCategory_com_google_web_bindery_requestfactory_shared_impl_ValueProxyCategory_com_google_web_bindery_requestfactory_shared_impl_BaseProxyCategory_0, AssignmentProxyAutoBean_com_google_web_bindery_requestfactory_shared_impl_EntityProxyCategory_com_google_web_bindery_requestfactory_shared_impl_ValueProxyCategory_com_google_web_bindery_requestfactory_shared_impl_BaseProxyCategory_1);
_.as = function as_8(){
  return this.shim;
}
;
...
defineSeed(1084, 606, {}, AssignmentRequestFactoryImpl_0);
...
defineSeed(1085, 616, makeCastMap([Q$AbstractRequestContext]), AssignmentRequestFactory_AssignmentRequestContextImpl_0);
...
defineSeed(1086, 615, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1087, 615, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$8X_0);
...
defineSeed(1088, 544, makeCastMap([Q$EnumMap]), AssignmentRequestFactory_AssignmentRequestContextImpl_FactoryImpl_0);
...
defineSeed(1119, 615, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$2X_0);
...
defineSeed(1123, 615, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$7X_0);
