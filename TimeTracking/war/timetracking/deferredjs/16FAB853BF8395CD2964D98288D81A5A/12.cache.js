...
defineSeed(737, 220, {}, LogTypeAddedEvent_0);
...
defineSeed(820, 687, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$HourAddUiHandler]), LogTypesAddPresenter_0);
...
defineSeed(821, 626, makeCastMap([Q$Receiver]), LogTypesAddPresenter$1_0);
...
;
_.this$0 = null;
defineSeed(829, 715, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$Place, Q$LogTypeAddedEvent$LogTypeAddedHandler]));
...
defineSeed(830, 699, {}, LogTypesPresenterMyProxyImpl$1_0);
...
defineSeed(831, 1, {}, LogTypesPresenterMyProxyImpl$1$1_0);
...
defineSeed(950, 692, makeCastMap([Q$LogTypesAddPresenter$MyView]), LogTypesAddView_0);
...
defineSeed(951, 1, {}, LogTypesAddView_BinderImpl_0);
function $build_f_HTMLPanel1_6(this$static){
  var attachRecord12, f_HTMLPanel1, f_VerticalPanel2, f_Label3, f_Grid4, f_Label5, txtHourName, f_Label6, txtHourActive, f_HorizontalPanel8, cmdCancel, sb, cmdAdd, sb_0;
  ...
  $addAndReplaceElement(f_HTMLPanel1, (f_VerticalPanel2 = new VerticalPanel_0 , $add_8(f_VerticalPanel2, (f_Label3 = new Label_0 , f_Label3.element['className'] = 'pageTitle' , $setTextOrHtml(f_Label3.directionalTextHelper, "Ajouter un type d'heure") , $updateHorizontalAlignment(f_Label3) , f_Label3)) , $add_8(f_VerticalPanel2, (f_Grid4 = new Grid_0 , $resizeColumns(f_Grid4, 2) , $resizeRows(f_Grid4, 3) , $setWidget_1(f_Grid4, 0, 0, (f_Label5 = new Label_0 , $setTextOrHtml(f_Label5.directionalTextHelper, 'Nom de type :') , $updateHorizontalAlignment(f_Label5) , f_Label5)) , $setWidget_1(f_Grid4, 0, 1, (txtHourName = new TextBox_0 , txtHourName.element.style['width'] = '250px' , this$static.owner.txtHourName = txtHourName , txtHourName)) , $setWidget_1(f_Grid4, 1, 0, (f_Label6 = new Label_0 , $setTextOrHtml(f_Label6.directionalTextHelper, 'Actif :') , $updateHorizontalAlignment(f_Label6) , f_Label6)) , $setWidget_1(f_Grid4, 1, 1, (txtHourActive = new CheckBox_0 , this$static.owner.txtHourActive = txtHourActive , txtHourActive)) , $setWidget_1(f_Grid4, 2, 0, new Label_0) , $setWidget_1(f_Grid4, 2, 1, (f_HorizontalPanel8 = new HorizontalPanel_0 , $setHorizontalAlignment(f_HorizontalPanel8, ($clinit_HasHorizontalAlignment() , ALIGN_RIGHT)) , $add_6(f_HorizontalPanel8, (cmdCancel = new Button_0 , $setHTML(cmdCancel, (sb = new StringBuilder_0 , $append_1(sb.data, 'Annuler') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb.data))).html) , $addDomHandler(cmdCancel, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, ($clinit_ClickEvent() , $clinit_ClickEvent() , TYPE_0)) , cmdCancel)) , $add_6(f_HorizontalPanel8, (cmdAdd = new Button_0 , $setHTML(cmdAdd, (sb_0 = new StringBuilder_0 , $append_1(sb_0.data, 'Ajouter') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb_0.data))).html) , $addDomHandler(cmdAdd, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2, TYPE_0) , cmdAdd)) , f_HorizontalPanel8.element.style['width'] = '100%' , f_HorizontalPanel8)) , f_Grid4)) , f_VerticalPanel2.element.style['width'] = '100%' , f_VerticalPanel2), $get_1(this$static.domId0Element));
  return f_HTMLPanel1;
}
...
defineSeed(952, 1, {}, LogTypesAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(953, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), LogTypesAddView_BinderImpl$Widgets$1_0);
...
defineSeed(954, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), LogTypesAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1130, 630, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$5X_0);
...
;
_.val$type = null;
var Lcom_lemania_timetracking_client_event_LogTypeAddedEvent_2_classLit = createForClass('com.lemania.timetracking.client.event.', 'LogTypeAddedEvent', 737), Lcom_lemania_timetracking_client_presenter_LogTypesAddPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'LogTypesAddPresenter', 820), Lcom_lemania_timetracking_client_presenter_LogTypesAddPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'LogTypesAddPresenter$1', 821), Lcom_lemania_timetracking_client_view_LogTypesAddView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'LogTypesAddView', 950), Lcom_lemania_timetracking_client_presenter_LogTypesPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'LogTypesPresenterMyProxyImpl$1', 830), Lcom_lemania_timetracking_client_presenter_LogTypesPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'LogTypesPresenterMyProxyImpl$1$1', 831), Lcom_lemania_timetracking_client_view_LogTypesAddView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'LogTypesAddView_BinderImpl', 951), Lcom_lemania_timetracking_client_view_LogTypesAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'LogTypesAddView_BinderImpl$Widgets', 952), Lcom_lemania_timetracking_client_view_LogTypesAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'LogTypesAddView_BinderImpl$Widgets$1', 953), Lcom_lemania_timetracking_client_view_LogTypesAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'LogTypesAddView_BinderImpl$Widgets$2', 954), Lcom_lemania_timetracking_shared_service_LogTypeRequestFactory_1LogTypeRequestContextImpl$5X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'LogTypeRequestFactory_LogTypeRequestContextImpl$5X', 1130);
$entry(onLoad)(12);
