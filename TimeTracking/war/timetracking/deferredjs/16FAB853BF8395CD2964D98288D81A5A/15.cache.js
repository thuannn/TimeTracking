...
defineSeed(785, 687, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(786, 626, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(787, 626, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(788, 626, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(789, 626, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(914, 692, makeCastMap([Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(915, 352, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(917, 352, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1107, 630, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
