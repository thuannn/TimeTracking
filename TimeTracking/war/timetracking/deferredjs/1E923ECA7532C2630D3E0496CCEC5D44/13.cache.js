...
function $createAndBindUi_1(owner){
  ...
  $setHTML(f_Button8, (sb_0 = new StringBuilder_0 , $append_2(sb_0.data, 'Extraire en Excel') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb_0.data))).html);
