...
defineSeed(738, 230, {}, LogTypeAddedEvent_0);
...
defineSeed(787, 680, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$HourAddUiHandler]), LogTypesAddPresenter_0);
...
defineSeed(788, 619, makeCastMap([Q$Receiver]), LogTypesAddPresenter$1_0);
...
;
_.this$0 = null;
defineSeed(796, 712, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LogTypeAddedEvent$LogTypeAddedHandler]));
...
defineSeed(797, 694, {}, LogTypesPresenterMyProxyImpl$1_0);
...
defineSeed(961, 685, makeCastMap([Q$IsWidget, Q$LogTypesAddPresenter$MyView]), LogTypesAddView_0);
...
defineSeed(962, 1, {}, LogTypesAddView_BinderImpl_0);
...
defineSeed(963, 1, {}, LogTypesAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(964, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), LogTypesAddView_BinderImpl$Widgets$1_0);
...
defineSeed(965, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), LogTypesAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1160, 623, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$5X_0);
