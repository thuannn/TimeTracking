...
defineSeed(749, 680, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(750, 619, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(751, 619, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(759, 712, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$CoursAddedEvent$CoursAddedHandler]));
...
defineSeed(760, 694, {}, CoursPresenterMyProxyImpl$1_0);
...
defineSeed(761, 1, {}, CoursPresenterMyProxyImpl$1$1_0);
...
defineSeed(920, 685, makeCastMap([Q$IsWidget, Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(921, 1, {}, CoursAddView_BinderImpl_0);
...
defineSeed(922, 1, {}, CoursAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(923, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$1_0);
...
defineSeed(924, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1138, 623, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
...
_.val$cours = null;
_.val$ecoleId = null;
var Lcom_lemania_timetracking_client_presenter_CoursAddPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursAddPresenter', 749), Lcom_lemania_timetracking_client_presenter_CoursAddPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursAddPresenter$1', 750), Lcom_lemania_timetracking_client_presenter_CoursAddPresenter$2_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursAddPresenter$2', 751), Lcom_lemania_timetracking_client_event_CoursAddedEvent_2_classLit = createForClass('com.lemania.timetracking.client.event.', 'CoursAddedEvent', 735), Lcom_lemania_timetracking_client_presenter_CoursPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursPresenterMyProxyImpl$1', 760), Lcom_lemania_timetracking_client_presenter_CoursPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursPresenterMyProxyImpl$1$1', 761), Lcom_lemania_timetracking_client_view_CoursAddView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursAddView', 920), Lcom_lemania_timetracking_client_view_CoursAddView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursAddView_BinderImpl', 921), Lcom_lemania_timetracking_client_view_CoursAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursAddView_BinderImpl$Widgets', 922), Lcom_lemania_timetracking_client_view_CoursAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursAddView_BinderImpl$Widgets$1', 923), Lcom_lemania_timetracking_client_view_CoursAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursAddView_BinderImpl$Widgets$2', 924), Lcom_lemania_timetracking_shared_service_CoursRequestFactory_1CoursRequestContextImpl$7X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'CoursRequestFactory_CoursRequestContextImpl$7X', 1138);
$entry(onLoad)(2);
