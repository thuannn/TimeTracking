...
defineSeed(838, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$RptTimeByProfPresenter, Q$ExtractDataUiHandler]), RptTimeByProfPresenter_0);
...
defineSeed(839, 619, makeCastMap([Q$Receiver]), RptTimeByProfPresenter$1_0);
...
defineSeed(840, 619, makeCastMap([Q$Receiver]), RptTimeByProfPresenter$2_0);
...
defineSeed(1038, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), RptTimeByProfView_BinderImpl$Widgets$3_0);
...
defineSeed(1155, 623, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$9X_0);
