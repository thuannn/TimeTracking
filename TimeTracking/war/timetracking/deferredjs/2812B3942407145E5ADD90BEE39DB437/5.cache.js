...
function $checkAccessBlock(this$static, response){
  ...
  if (!currentUser.isAdmin) {
    if (this$static.systemBlocked.value_0) {
      alert_0("L'acc\xE8s au syst\xE8me est limit\xE9 pour l'instant.");
      return;
    }
  ...
  $toggleLoginPanel(dynamicCast(this$static.view, Q$HomePresenter$MyView), ($clinit_Boolean() , $clinit_Boolean() , FALSE));
}

function HomePresenter_0(eventBus, view){
  PresenterWidget_0.call(this, eventBus, view);
  this.systemBlocked = ($clinit_Boolean() , $clinit_Boolean() , FALSE);
}
...
function $onSuccess_12(this$static, response){
  ...
  for (setting$iterator = response.iterator(); setting$iterator.hasNext();) {
    ...
    $equals_5(setting.getOptionName(), 'BLOCK') && (this$static.this$0.systemBlocked = ($clinit_Boolean() , $clinit_Boolean() , $equalsIgnoreCase('true', setting.getOptionValue())?TRUE:FALSE));
  }
...
function HomePresenter$2(){
}

_ = HomePresenter$2_0.prototype = HomePresenter$2.prototype = new Receiver;
_.getClass$ = function getClass_568(){
  return Lcom_lemania_timetracking_client_presenter_HomePresenter$2_2_classLit;
}
;
...
_.onSuccess_0 = function onSuccess_30(response){
  $onSuccess_13(this, dynamicCast(response, Q$UserProxy));
}
;
_.castableTypeMap$ = makeCastMap([Q$Receiver]);
_.this$0 = null;
