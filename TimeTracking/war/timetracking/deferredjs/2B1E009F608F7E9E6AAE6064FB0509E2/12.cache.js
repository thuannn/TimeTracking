...
defineSeed(840, 680, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget]), RptTimeBySchoolPresenter_0);
...
defineSeed(841, 619, makeCastMap([Q$Receiver]), RptTimeBySchoolPresenter$1_0);
...
defineSeed(1022, 685, makeCastMap([Q$IsWidget, Q$RptTimeBySchoolPresenter$MyView, Q$RptTimeBySchoolView]), RptTimeBySchoolView_0);
...
defineSeed(1023, 383, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$1_0);
...
defineSeed(1024, 383, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$10_0);
...
defineSeed(1025, 383, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$11_0);
...
defineSeed(1026, 383, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$12_0);
...
defineSeed(1027, 383, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$13_0);
...
defineSeed(1028, 383, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$2_0);
...
defineSeed(1029, 383, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$3_0);
...
defineSeed(1030, 383, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$4_0);
...
defineSeed(1031, 383, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$5_0);
...
defineSeed(1032, 383, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$6_0);
...
defineSeed(1033, 383, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$7_0);
...
defineSeed(1034, 383, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$8_0);
...
defineSeed(1035, 383, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$9_0);
