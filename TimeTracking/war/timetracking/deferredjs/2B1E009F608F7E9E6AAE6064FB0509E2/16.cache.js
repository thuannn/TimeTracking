...
defineSeed(783, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LogTypeAddedEvent$LogTypeAddedHandler, Q$LogTypesPresenter, Q$LogTypeListUiHandler]), LogTypesPresenter_0);
...
defineSeed(784, 619, makeCastMap([Q$Receiver]), LogTypesPresenter$1_0);
...
defineSeed(785, 619, makeCastMap([Q$Receiver]), LogTypesPresenter$2_0);
...
defineSeed(786, 619, makeCastMap([Q$Receiver]), LogTypesPresenter$3_0);
...
defineSeed(787, 619, makeCastMap([Q$Receiver]), LogTypesPresenter$4_0);
...
defineSeed(955, 685, makeCastMap([Q$IsWidget, Q$LogTypesPresenter$MyView]), LogTypesView_0);
...
defineSeed(956, 357, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$1_0);
...
defineSeed(958, 357, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$3_0);
...
defineSeed(960, 357, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$5_0);
...
defineSeed(1127, 623, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$2X_0);
...
defineSeed(1129, 623, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$6X_0);
