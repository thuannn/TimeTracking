...
defineSeed(752, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(753, 619, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(754, 619, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(755, 619, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(756, 619, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(919, 685, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(920, 357, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(921, 1, {}, CoursView$2_0);
...
defineSeed(922, 357, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(923, 1, {}, CoursView$4_0);
...
defineSeed(924, 1, {}, CoursView_BinderImpl_0);
...
defineSeed(925, 1, {}, CoursView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(926, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), CoursView_BinderImpl$Widgets$1_0);
...
defineSeed(1107, 623, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
...
;
_.val$newCours = null;
var Lcom_lemania_timetracking_client_presenter_CoursPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursPresenter', 752), Lcom_lemania_timetracking_client_presenter_CoursPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursPresenter$1', 753), Lcom_lemania_timetracking_client_presenter_CoursPresenter$2_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursPresenter$2', 754), Lcom_lemania_timetracking_client_presenter_CoursPresenter$3_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursPresenter$3', 755), Lcom_lemania_timetracking_client_presenter_CoursPresenter$4_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursPresenter$4', 756), Lcom_lemania_timetracking_client_view_CoursView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView', 919), Lcom_lemania_timetracking_client_view_CoursView$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView$1', 920), Lcom_lemania_timetracking_client_view_CoursView$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView$2', 921), Lcom_lemania_timetracking_client_view_CoursView$3_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView$3', 922), Lcom_lemania_timetracking_client_view_CoursView$4_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView$4', 923), Lcom_lemania_timetracking_client_view_CoursView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView_BinderImpl', 924), Lcom_lemania_timetracking_client_view_CoursView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView_BinderImpl$Widgets', 925), Lcom_lemania_timetracking_client_view_CoursView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView_BinderImpl$Widgets$1', 926), Lcom_lemania_timetracking_shared_service_CoursRequestFactory_1CoursRequestContextImpl$8X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'CoursRequestFactory_CoursRequestContextImpl$8X', 1107);
$entry(onLoad)(3);
