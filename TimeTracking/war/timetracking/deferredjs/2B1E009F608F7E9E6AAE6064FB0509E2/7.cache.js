...
defineSeed(772, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(773, 619, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(774, 619, makeCastMap([Q$Receiver]), HomePresenter$2_0);
_.onFailure_0 = function onFailure_11(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_11(response){
  $onSuccess_11(this, dynamicCast(response, Q$UserProxy));
}
;
_.this$0 = null;
...
function HomeView_0(){
  this.widget = $build_f_HTMLPanel1_4(new HomeView_HomeViewUiBinderImpl$Widgets_0(this));
}

defineSeed(942, 685, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1148, 623, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$2X_0);
