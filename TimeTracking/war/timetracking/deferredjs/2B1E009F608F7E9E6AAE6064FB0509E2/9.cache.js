...
defineSeed(804, 680, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(805, 619, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(806, 619, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(807, 619, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(808, 619, makeCastMap([Q$Receiver]), ProfsPresenter$4_0);
...
defineSeed(809, 619, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(810, 619, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(811, 619, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(992, 685, makeCastMap([Q$IsWidget, Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(993, 357, makeCastMap([Q$HasCell, Q$Column]), ProfsView$1_0);
...
defineSeed(995, 357, makeCastMap([Q$HasCell, Q$Column]), ProfsView$3_0);
...
defineSeed(998, 383, makeCastMap([Q$HasCell, Q$Column]), ProfsView$6_0);
...
defineSeed(999, 383, makeCastMap([Q$HasCell, Q$Column]), ProfsView$7_0);
...
defineSeed(1074, 580, makeCastMap([Q$AutoBean, Q$AbstractAutoBean, Q$HasSplittable]), AssignmentProxyAutoBean_com_google_web_bindery_requestfactory_shared_impl_EntityProxyCategory_com_google_web_bindery_requestfactory_shared_impl_ValueProxyCategory_com_google_web_bindery_requestfactory_shared_impl_BaseProxyCategory_0, AssignmentProxyAutoBean_com_google_web_bindery_requestfactory_shared_impl_EntityProxyCategory_com_google_web_bindery_requestfactory_shared_impl_ValueProxyCategory_com_google_web_bindery_requestfactory_shared_impl_BaseProxyCategory_1);
_.as = function as_8(){
  return this.shim;
}
;
...
defineSeed(1098, 614, {}, AssignmentRequestFactoryImpl_0);
...
defineSeed(1099, 624, makeCastMap([Q$AbstractRequestContext]), AssignmentRequestFactory_AssignmentRequestContextImpl_0);
...
defineSeed(1100, 623, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1101, 623, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$8X_0);
...
defineSeed(1102, 552, makeCastMap([Q$EnumMap]), AssignmentRequestFactory_AssignmentRequestContextImpl_FactoryImpl_0);
...
defineSeed(1133, 623, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$2X_0);
...
defineSeed(1138, 623, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$8X_0);
