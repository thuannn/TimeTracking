...
function $render_2(this$static, context, value, sb){
  ...
  s != null?$append_3(sb, (sb_0 = new StringBuilder_0 , $append_2(sb_0.data, '<input type="text" value="') , $append_8(sb_0, htmlEscape(s)) , $append_2(sb_0.data, '" tabindex="-1"><\/input>') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb_0.data)))):($append_8(sb.sb, '<input type="text" tabindex="-1"><\/input>') , sb);
}
...
function $loadProfessorsByCourse(this$static, courseId){
  ...
  $fire((x = new ProfessorRequestFactory_ProfessorRequestContextImpl$2X_0(rc, courseId) , $addInvocation(rc.state.dialect, x) , x), new TimeInputPresenter$2_0(this$static));
}
...
_.onReset = function onReset_7(){
  ...
  $initialize_0(rfl, this.eventBus, new DefaultRequestTransport_0);
...
_.onSuccess_0 = function onSuccess_40(response){
  $onSuccess_27(this, throwClassCastExceptionUnlessNull(response));
}
;
_.castableTypeMap$ = makeCastMap([Q$Receiver]);
_.this$0 = null;
...
_.success = function success_7(presenter){
  $success_5(this, dynamicCast(presenter, Q$TimeInputPresenter));
}
;
_.val$event = null;
...
function $initializeValues(this$static, currentMonth, currentYear){
  ...
  for (i = 0; i < 5; ++i) {
    $insertItem(this$static.lstYear, '' + (i + 2011), '' + (i + 2011), -1);
    i + 2011 == currentYear && $setSelectedIndex_0(this$static.lstYear, i);
  }
}
...
;
_.getValue = function getValue_21(log){
...
;
_.getValue = function getValue_22(log){
...
function $save_1(this$static, log){
  var x;
  x = new LogRequestFactory_LogRequestContextImpl$7X_0(this$static, log);
  $addInvocation(this$static.state.dialect, x);
  return x;
}
...
_.val$profId = null;
_.val$year = null;
function LogRequestFactory_LogRequestContextImpl$7X_0(this$0, val$log){
  this.val$log = val$log;
  AbstractRequest_0.call(this, this$0);
}

function LogRequestFactory_LogRequestContextImpl$7X(){
}

_ = LogRequestFactory_LogRequestContextImpl$7X_0.prototype = LogRequestFactory_LogRequestContextImpl$7X.prototype = new AbstractRequest;
_.getClass$ = function getClass_762(){
  return Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$7X_2_classLit;
}
;
