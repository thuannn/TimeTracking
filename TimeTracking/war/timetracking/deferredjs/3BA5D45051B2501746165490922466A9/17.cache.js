...
defineSeed(783, 672, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LogTypeAddedEvent$LogTypeAddedHandler, Q$LogTypesPresenter, Q$LogTypeListUiHandler]), LogTypesPresenter_0);
...
defineSeed(784, 611, makeCastMap([Q$Receiver]), LogTypesPresenter$1_0);
...
defineSeed(785, 611, makeCastMap([Q$Receiver]), LogTypesPresenter$2_0);
...
defineSeed(786, 611, makeCastMap([Q$Receiver]), LogTypesPresenter$3_0);
...
defineSeed(787, 611, makeCastMap([Q$Receiver]), LogTypesPresenter$4_0);
...
defineSeed(959, 677, makeCastMap([Q$IsWidget, Q$LogTypesPresenter$MyView]), LogTypesView_0);
...
defineSeed(960, 353, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$1_0);
...
defineSeed(962, 353, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$3_0);
...
defineSeed(964, 353, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$5_0);
...
defineSeed(1110, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$LogTypeProxy]));
...
;
defineSeed(1111, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$LogTypeProxy]));
...
defineSeed(1151, 615, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$2X_0);
...
defineSeed(1153, 615, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$6X_0);
