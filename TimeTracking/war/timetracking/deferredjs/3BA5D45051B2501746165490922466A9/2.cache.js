...
defineSeed(727, 229, {}, CoursAddedEvent_0);
...
defineSeed(741, 672, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(742, 611, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(743, 611, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(751, 704, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$CoursAddedEvent$CoursAddedHandler]));
...
defineSeed(752, 686, {}, CoursPresenterMyProxyImpl$1_0);
...
defineSeed(912, 677, makeCastMap([Q$IsWidget, Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(913, 1, {}, CoursAddView_BinderImpl_0);
...
defineSeed(914, 1, {}, CoursAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(915, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$1_0);
...
defineSeed(916, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1130, 615, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
