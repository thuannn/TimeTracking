...
defineSeed(830, 672, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$RptTimeByProfPresenter, Q$ExtractDataUiHandler]), RptTimeByProfPresenter_0);
...
defineSeed(831, 611, makeCastMap([Q$Receiver]), RptTimeByProfPresenter$1_0);
...
defineSeed(832, 611, makeCastMap([Q$Receiver]), RptTimeByProfPresenter$2_0);
...
defineSeed(1030, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), RptTimeByProfView_BinderImpl$Widgets$3_0);
...
defineSeed(1147, 615, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$9X_0);
...
_.val$profId = null;
_.val$year = null;
var Lcom_lemania_timetracking_client_presenter_RptTimeByProfPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByProfPresenter', 830), Lcom_lemania_timetracking_client_presenter_RptTimeByProfPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByProfPresenter$1', 831), Lcom_lemania_timetracking_client_presenter_RptTimeByProfPresenter$2_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByProfPresenter$2', 832), Lcom_lemania_timetracking_client_view_RptTimeByProfView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByProfView', 1025), Lcom_lemania_timetracking_client_view_RptTimeByProfView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByProfView_BinderImpl', 1026), Lcom_lemania_timetracking_client_view_RptTimeByProfView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByProfView_BinderImpl$Widgets', 1027), Lcom_lemania_timetracking_client_view_RptTimeByProfView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByProfView_BinderImpl$Widgets$1', 1028), Lcom_lemania_timetracking_client_view_RptTimeByProfView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByProfView_BinderImpl$Widgets$2', 1029), Lcom_lemania_timetracking_client_view_RptTimeByProfView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByProfView_BinderImpl$Widgets$3', 1030), Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$9X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'LogRequestFactory_LogRequestContextImpl$9X', 1147);
$entry(onLoad)(6);
