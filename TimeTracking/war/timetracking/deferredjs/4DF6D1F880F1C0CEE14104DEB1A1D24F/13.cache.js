...
defineSeed(841, 683, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(842, 622, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(843, 622, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(844, 622, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1038, 688, makeCastMap([Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1039, 1, {}, SettingsView_BinderImpl_0);
...
defineSeed(1040, 1, {}, SettingsView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1041, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), SettingsView_BinderImpl$Widgets$1_0);
...
defineSeed(1148, 626, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
