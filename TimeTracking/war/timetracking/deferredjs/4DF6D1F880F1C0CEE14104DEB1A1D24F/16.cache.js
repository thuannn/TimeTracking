...
defineSeed(791, 683, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LogTypeAddedEvent$LogTypeAddedHandler, Q$LogTypesPresenter, Q$LogTypeListUiHandler]), LogTypesPresenter_0);
...
defineSeed(792, 622, makeCastMap([Q$Receiver]), LogTypesPresenter$1_0);
...
defineSeed(793, 622, makeCastMap([Q$Receiver]), LogTypesPresenter$2_0);
...
defineSeed(794, 622, makeCastMap([Q$Receiver]), LogTypesPresenter$3_0);
...
defineSeed(795, 622, makeCastMap([Q$Receiver]), LogTypesPresenter$4_0);
...
defineSeed(959, 688, makeCastMap([Q$LogTypesPresenter$MyView]), LogTypesView_0);
...
defineSeed(960, 351, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$1_0);
...
defineSeed(961, 1, {}, LogTypesView$2_0);
...
defineSeed(962, 351, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$3_0);
...
defineSeed(963, 1, {}, LogTypesView$4_0);
...
defineSeed(964, 351, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$5_0);
...
defineSeed(965, 1, {}, LogTypesView$6_0);
...
defineSeed(966, 1, {}, LogTypesView_BinderImpl_0);
...
defineSeed(967, 1, {}, LogTypesView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1132, 626, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$2X_0);
...
defineSeed(1135, 626, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$6X_0);
