...
defineSeed(780, 683, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(781, 622, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(782, 622, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(946, 688, makeCastMap([Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1153, 626, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$2X_0);
