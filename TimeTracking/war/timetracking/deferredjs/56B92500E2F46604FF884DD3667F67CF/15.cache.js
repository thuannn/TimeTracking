...
defineSeed(749, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(780, 682, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(781, 621, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(782, 621, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(783, 621, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(784, 621, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(909, 687, makeCastMap([Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(910, 351, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(912, 351, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1102, 625, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
