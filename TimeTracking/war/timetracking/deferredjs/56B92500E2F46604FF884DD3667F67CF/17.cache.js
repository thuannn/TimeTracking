...
defineSeed(819, 682, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LogTypeAddedEvent$LogTypeAddedHandler, Q$LogTypesPresenter, Q$LogTypeListUiHandler]), LogTypesPresenter_0);
...
defineSeed(820, 621, makeCastMap([Q$Receiver]), LogTypesPresenter$1_0);
...
defineSeed(821, 621, makeCastMap([Q$Receiver]), LogTypesPresenter$2_0);
...
defineSeed(822, 621, makeCastMap([Q$Receiver]), LogTypesPresenter$3_0);
...
defineSeed(823, 621, makeCastMap([Q$Receiver]), LogTypesPresenter$4_0);
...
defineSeed(951, 687, makeCastMap([Q$LogTypesPresenter$MyView]), LogTypesView_0);
...
defineSeed(952, 351, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$1_0);
...
defineSeed(954, 351, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$3_0);
...
defineSeed(956, 351, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$5_0);
...
;
defineSeed(1083, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$LogTypeProxy]));
...
defineSeed(1123, 625, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$2X_0);
...
defineSeed(1126, 625, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$6X_0);
