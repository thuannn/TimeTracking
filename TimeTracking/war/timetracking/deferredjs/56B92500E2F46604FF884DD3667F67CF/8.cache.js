...
defineSeed(768, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(800, 682, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ExtractDataPresenter, Q$ExtractDataUiHandler]), ExtractDataPresenter_0);
...
defineSeed(801, 621, makeCastMap([Q$Receiver]), ExtractDataPresenter$1_0);
...
defineSeed(802, 621, makeCastMap([Q$Receiver]), ExtractDataPresenter$2_0);
...
defineSeed(803, 621, makeCastMap([Q$Receiver]), ExtractDataPresenter$3_0);
...
defineSeed(932, 687, makeCastMap([Q$ExtractDataPresenter$MyView, Q$ExtractDataView]), ExtractDataView_0);
...
defineSeed(1119, 625, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$8X_0);
