...
defineSeed(799, 663, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$RptTimeByDepartmentPresenter, Q$RptTimeByDepartmentUiHandler]), RptTimeByDepartmentPresenter_0);
...
defineSeed(800, 602, makeCastMap([Q$Receiver]), RptTimeByDepartmentPresenter$1_0);
...
defineSeed(801, 602, makeCastMap([Q$Receiver]), RptTimeByDepartmentPresenter$2_0);
...
defineSeed(988, 668, makeCastMap([Q$IsWidget, Q$RptTimeByDepartmentPresenter$MyView, Q$RptTimeByDepartmentView]), RptTimeByDepartmentView_0);
...
defineSeed(1119, 606, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$5X_0);
