...
defineSeed(411, 412, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$FocusWidget, Q$Focusable, Q$HasFocus, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), Button_1);
...
defineSeed(415, 412, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$CheckBox, Q$FocusWidget, Q$Focusable, Q$HasFocus, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), CheckBox_2);
...
defineSeed(487, 419, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]));
...
defineSeed(506, 485, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$FocusWidget, Q$Focusable, Q$HasFocus, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), TextArea_1);
...
defineSeed(544, 1, makeCastMap([Q$Iterable, Q$Collection, Q$List]));
...
defineSeed(746, 232, {}, LoadAllProfessorLogsEvent_0);
...
defineSeed(749, 232, {}, UpdateTimeLogEvent_0);
...
defineSeed(865, 688, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ActionCompletedEvent$ActionCompletedHandler, Q$LoadAllProfessorLogsEvent$LoadAllProfessorLogsHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$UpdateTimeLogEvent$UpdateTimeLogHandler, Q$TimeInputPresenter, Q$TimeInputUiHandler]), TimeInputPresenter_0);
...
defineSeed(866, 624, makeCastMap([Q$Receiver]), TimeInputPresenter$1_0);
...
defineSeed(867, 624, makeCastMap([Q$Receiver]), TimeInputPresenter$2_0);
...
defineSeed(868, 624, makeCastMap([Q$Receiver]), TimeInputPresenter$3_0);
...
defineSeed(869, 624, makeCastMap([Q$Receiver]), TimeInputPresenter$6_0);
...
defineSeed(870, 624, makeCastMap([Q$Receiver]), TimeInputPresenter$7_0);
...
defineSeed(871, 624, makeCastMap([Q$Receiver]), TimeInputPresenter$8_0);
...
defineSeed(872, 624, makeCastMap([Q$Receiver]), TimeInputPresenter$9_0);
...
defineSeed(874, 702, {}, TimeInputPresenterMyProxyImpl$1_0);
...
defineSeed(875, 1, {}, TimeInputPresenterMyProxyImpl$1$1_0);
...
defineSeed(880, 702, {}, TimeInputPresenterMyProxyImpl$4_0);
...
defineSeed(881, 1, {}, TimeInputPresenterMyProxyImpl$4$1_0);
...
defineSeed(1096, 693, makeCastMap([Q$IsWidget, Q$TimeInputPresenter$MyView]), TimeInputView_0);
...
defineSeed(1097, 379, makeCastMap([Q$HasCell, Q$Column]), TimeInputView$1_0);
...
defineSeed(1098, 379, makeCastMap([Q$HasCell, Q$Column]), TimeInputView$2_0);
...
defineSeed(1099, 552, makeCastMap([Q$HasHandlers]), TimeInputView$3_0);
...
defineSeed(1100, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), TimeInputView$4_0);
...
defineSeed(1101, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), TimeInputView$5_0);
...
defineSeed(1102, 1, makeCastMap([Q$CloseHandler, Q$EventHandler]), TimeInputView$6_0);
...
defineSeed(1103, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), TimeInputView$7_0);
...
defineSeed(1104, 1, {}, TimeInputView_BinderImpl_0);
...
defineSeed(1105, 1, {}, TimeInputView_BinderImpl$Widgets_0);
function TimeInputView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1106, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$1_0);
...
defineSeed(1107, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$10_0);
...
defineSeed(1108, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$11_0);
...
defineSeed(1109, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$12_0);
...
defineSeed(1110, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$13_0);
...
defineSeed(1111, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$14_0);
...
defineSeed(1112, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$15_0);
...
defineSeed(1113, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$16_0);
...
defineSeed(1114, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$17_0);
...
defineSeed(1115, 1, makeCastMap([Q$MouseDownHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$18_0);
...
defineSeed(1116, 1, makeCastMap([Q$MouseDownHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$19_0);
...
defineSeed(1117, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$2_0);
...
defineSeed(1118, 1, makeCastMap([Q$MouseDownHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$20_0);
...
defineSeed(1119, 1, makeCastMap([Q$MouseDownHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$21_0);
...
defineSeed(1120, 1, makeCastMap([Q$MouseDownHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$22_0);
...
defineSeed(1121, 1, makeCastMap([Q$MouseDownHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$23_0);
...
defineSeed(1122, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$3_0);
...
defineSeed(1123, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$4_0);
...
defineSeed(1124, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$5_0);
...
defineSeed(1125, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$6_0);
...
defineSeed(1126, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$7_0);
...
defineSeed(1127, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$8_0);
...
defineSeed(1128, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$9_0);
...
defineSeed(1164, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$ProfessorProxy]));
...
;
defineSeed(1165, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$ProfessorProxy]));
...
defineSeed(1178, 619, {}, ContactRequestFactoryImpl_0);
...
defineSeed(1179, 629, makeCastMap([Q$AbstractRequestContext]), ContactRequestFactory_ContactRequestContextImpl_0);
...
defineSeed(1180, 628, makeCastMap([Q$AbstractRequest]), ContactRequestFactory_ContactRequestContextImpl$3X_0);
...
defineSeed(1181, 554, makeCastMap([Q$EnumMap]), ContactRequestFactory_ContactRequestContextImpl_FactoryImpl_0);
...
defineSeed(1199, 628, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$10X_0);
...
defineSeed(1201, 628, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$15X_0);
...
defineSeed(1202, 628, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$1X_0);
...
defineSeed(1203, 628, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$5X_0);
...
defineSeed(1218, 628, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$4X_0);
...
;
defineSeed(1243, 1, makeCastMap([Q$Iterable, Q$Collection, Q$List]));
...
defineSeed(1314, 1312, makeCastMap([Q$Iterable, Q$Collection, Q$List]));
_.add_0 = function add_20(index_0, element){
  throw new UnsupportedOperationException_0;
}
;
var Lcom_lemania_timetracking_client_presenter_TimeInputPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter', 865), Lcom_lemania_timetracking_client_presenter_TimeInputPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter$1', 866), Lcom_lemania_timetracking_client_presenter_TimeInputPresenter$2_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter$2', 867), Lcom_lemania_timetracking_client_presenter_TimeInputPresenter$3_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter$3', 868), Lcom_lemania_timetracking_client_presenter_TimeInputPresenter$6_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter$6', 869), Lcom_lemania_timetracking_client_presenter_TimeInputPresenter$7_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter$7', 870), Lcom_lemania_timetracking_client_presenter_TimeInputPresenter$8_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter$8', 871), Lcom_lemania_timetracking_client_presenter_TimeInputPresenter$9_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter$9', 872), Lcom_lemania_timetracking_client_event_UpdateTimeLogEvent_2_classLit = createForClass('com.lemania.timetracking.client.event.', 'UpdateTimeLogEvent', 749), Lcom_lemania_timetracking_client_event_LoadAllProfessorLogsEvent_2_classLit = createForClass('com.lemania.timetracking.client.event.', 'LoadAllProfessorLogsEvent', 746), Lcom_lemania_timetracking_client_presenter_TimeInputPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenterMyProxyImpl$1', 874), Lcom_lemania_timetracking_client_presenter_TimeInputPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenterMyProxyImpl$1$1', 875), Lcom_lemania_timetracking_client_presenter_TimeInputPresenterMyProxyImpl$4_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenterMyProxyImpl$4', 880), Lcom_lemania_timetracking_client_presenter_TimeInputPresenterMyProxyImpl$4$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenterMyProxyImpl$4$1', 881), Lcom_lemania_timetracking_client_view_TimeInputView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 
2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$17', 1114), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$18_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$18', 1115), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$19_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$19', 1116), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$20_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$20', 1118), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$21_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$21', 1119), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$22_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$22', 1120), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$23_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$23', 1121), Lcom_lemania_timetracking_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$4X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$4X', 1218), Lcom_google_gwt_event_dom_client_MouseDownEvent_2_classLit = createForClass('com.google.gwt.event.dom.client.', 'MouseDownEvent', 244), Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$1X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'LogRequestFactory_LogRequestContextImpl$1X', 1202), Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$5X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'LogRequestFactory_LogRequestContextImpl$5X', 1203), Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$10X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'LogRequestFactory_LogRequestContextImpl$10X', 1199), Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$15X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'LogRequestFactory_LogRequestContextImpl$15X', 1201), Lcom_google_gwt_user_client_ui_TextArea_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'TextArea', 506), Lcom_lemania_timetracking_shared_service_ContactRequestFactoryImpl_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ContactRequestFactoryImpl', 1178), Lcom_lemania_timetracking_shared_service_ContactRequestFactory_1ContactRequestContextImpl_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl', 1179), Lcom_lemania_timetracking_shared_service_ContactRequestFactory_1ContactRequestContextImpl$3X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl$3X', 1180), Lcom_lemania_timetracking_shared_service_ContactRequestFactory_1ContactRequestContextImpl_1FactoryImpl_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl_FactoryImpl', 1181);
$entry(onLoad)(15);
