...
defineSeed(746, 672, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(747, 611, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(748, 611, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(749, 611, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(750, 611, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(918, 677, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(919, 354, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(921, 354, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1131, 615, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
