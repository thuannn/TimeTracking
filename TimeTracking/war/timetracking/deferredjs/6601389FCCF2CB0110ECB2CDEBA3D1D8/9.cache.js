...
_.onSuccess_0 = function onSuccess_52(response){
  $onSuccess_36(this, throwClassCastExceptionUnlessNull(response));
}
;
_.castableTypeMap$ = makeCastMap([Q$Receiver]);
_.this$0 = null;
...
function UserManagementView_0(){
  ...
  this.widget = $createAndBindUi_8(this);
}
...
;
_.castableTypeMap$ = makeCastMap([Q$Column]);
function $createAndBindUi_8(owner){
