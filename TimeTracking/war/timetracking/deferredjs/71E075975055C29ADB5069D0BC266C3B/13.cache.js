...
defineSeed(830, 672, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(831, 611, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(832, 611, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(833, 611, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1025, 677, makeCastMap([Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1128, 615, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
