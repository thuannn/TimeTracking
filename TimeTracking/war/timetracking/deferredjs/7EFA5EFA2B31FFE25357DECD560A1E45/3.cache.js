...
function $updateUserStatus(this$static, user, active, admin){
...
_.onReset = function onReset_10(){
  ...
  rc = new UserRequestFactory_UserRequestContextImpl_0(rf);
  $fire((x = new UserRequestFactory_UserRequestContextImpl$5X_0(rc) , $addInvocation(rc.state.dialect, x) , x), new UserManagementPresenter$1_0(this));
...
_.onSuccess_0 = function onSuccess_50(response){
  $onSuccess_35(this, throwClassCastExceptionUnlessNull(response));
}
;
_.castableTypeMap$ = makeCastMap([Q$Receiver]);
_.this$0 = null;
...
function $initializeDepartmentTable(this$static){
  var colCourseName;
  colCourseName = new UserManagementView$8_0;
  $addColumn(this$static.tblDepartment, colCourseName, 'D\xE9partement');
}

function $initializeTables(this$static){
  var cellActive, cellAdmin, colActive, colAdmin, colFullName, colUserName, selectionModel;
  ...
  colActive = new UserManagementView$3_0(cellActive);
  $addColumn(this$static.tblUser, colActive, 'Actif');
  $setFieldUpdater(colActive, new UserManagementView$4_0(this$static));
  cellAdmin = new CheckboxCell_0;
  colAdmin = new UserManagementView$5_0(cellAdmin);
  $addColumn(this$static.tblUser, colAdmin, 'Admin');
  $setFieldUpdater(colAdmin, new UserManagementView$6_0(this$static));
  selectionModel = new SingleSelectionModel_0;
  $setSelectionModel(this$static.tblUser, selectionModel);
  $addSelectionChangeHandler(selectionModel, new UserManagementView$7_0(this$static, selectionModel));
...
function $populateSelectedUserInfo(this$static){
  if (this$static.selectedUser) {
    $setText_1(this$static.txtFullName, this$static.selectedUser.getFullName());
    $setText_1(this$static.txtUserName, this$static.selectedUser.getUserName());
    $setText_1(this$static.txtEmail, this$static.selectedUser.getEmail());
  }
}
...
;
_.getValue = function getValue_50(ecole){
  return dynamicCast(ecole, Q$UserProxy).getActive();
}
;
_.castableTypeMap$ = makeCastMap([Q$Column]);
function $update_6(this$static, index, user, value){
...
;
_.update = function update_5(index, user, value){
  $update_6(this, index, dynamicCast(user, Q$UserProxy), dynamicCast(value, Q$Boolean));
}
;
_.this$0 = null;
...
;
_.getValue = function getValue_51(user){
...
_.update = function update_6(index, user, value){
  $update_7(this, index, dynamicCast(user, Q$UserProxy), dynamicCast(value, Q$Boolean));
}
;
_.this$0 = null;
function UserManagementView$7_0(this$0, val$selectionModel){
  this.this$0 = this$0;
...
_ = UserManagementView$7_0.prototype = UserManagementView$7.prototype = new Object_0;
...
function UserManagementView$8_0(){
  TextColumn_0.call(this);
}
...
_ = UserManagementView$8_0.prototype = UserManagementView$8.prototype = new TextColumn;
...
function $createAndBindUi_7(owner){
  ...
  f_HTMLPanel1 = new HTMLPanel_0((sb = new StringBuilder_0 , $append_2(sb.data, "<span id='") , $append_8(sb, htmlEscape(domId0)) , $append_2(sb.data, "'><\/span> <span id='") , $append_8(sb, htmlEscape(domId1)) , $append_2(sb.data, "'><\/span>") , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb.data))).html);
  ...
  f_Label2.element.style['width'] = '830';
...
function $save_4(this$static, user){
  var x;
  x = new UserRequestFactory_UserRequestContextImpl$8X_0(this$static, user);
...
function UserRequestFactory_UserRequestContextImpl$5X(){
}

_ = UserRequestFactory_UserRequestContextImpl$5X_0.prototype = UserRequestFactory_UserRequestContextImpl$5X.prototype = new AbstractRequest;
_.getClass$ = function getClass_826(){
  return Lcom_lemania_timetracking_shared_service_UserRequestFactory_1UserRequestContextImpl$5X_2_classLit;
}
;
...
;
_.castableTypeMap$ = makeCastMap([Q$AbstractRequest]);
function UserRequestFactory_UserRequestContextImpl$8X_0(this$0, val$user){
  this.val$user = val$user;
  AbstractRequest_0.call(this, this$0);
}

function UserRequestFactory_UserRequestContextImpl$8X(){
}

_ = UserRequestFactory_UserRequestContextImpl$8X_0.prototype = UserRequestFactory_UserRequestContextImpl$8X.prototype = new AbstractRequest;
_.getClass$ = function getClass_827(){
  return Lcom_lemania_timetracking_shared_service_UserRequestFactory_1UserRequestContextImpl$8X_2_classLit;
}
;
