...
defineSeed(820, 691, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ProfessorAddUiHandler]), ProfsAddPresenter_0);
...
defineSeed(821, 627, makeCastMap([Q$Receiver]), ProfsAddPresenter$1_0);
...
defineSeed(1033, 696, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView, Q$ProfsAddView]), ProfsAddView_0);
...
defineSeed(1034, 1, {}, ProfsAddView_BinderImpl_0);
...
defineSeed(1035, 1, {}, ProfsAddView_BinderImpl$Widgets_0);
function ProfsAddView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1036, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ProfsAddView_BinderImpl$Widgets$1_0);
...
defineSeed(1037, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ProfsAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1223, 631, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$9X_0);
...
;
var Lcom_lemania_timetracking_client_presenter_ProfsAddPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'ProfsAddPresenter', 820), Lcom_lemania_timetracking_client_presenter_ProfsAddPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'ProfsAddPresenter$1', 821), Lcom_lemania_timetracking_client_view_ProfsAddView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'ProfsAddView', 1033), Lcom_lemania_timetracking_client_view_ProfsAddView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'ProfsAddView_BinderImpl', 1034), Lcom_lemania_timetracking_client_view_ProfsAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'ProfsAddView_BinderImpl$Widgets', 1035), Lcom_lemania_timetracking_client_view_ProfsAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'ProfsAddView_BinderImpl$Widgets$1', 1036), Lcom_lemania_timetracking_client_view_ProfsAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'ProfsAddView_BinderImpl$Widgets$2', 1037), Lcom_lemania_timetracking_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$9X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$9X', 1223);
$entry(onLoad)(9);
