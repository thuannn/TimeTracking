...
function $createAndBindUi_4(owner){
  ...
  $setValue_1(chkProfStatus, ($clinit_Boolean() , $clinit_Boolean() , TRUE));
  $setHorizontalAlignment_0(f_HorizontalPanel9, ($clinit_HasHorizontalAlignment() , ALIGN_RIGHT));
  $setHTML(cmdCancel, (sb_0 = new StringBuilder_0 , $append_2(sb_0.data, 'Annuler') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb_0.data))).html);
  $add_6(f_HorizontalPanel9, cmdCancel);
  $setHTML(cmdAdd, (sb_1 = new StringBuilder_0 , $append_2(sb_1.data, 'Ajouter') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb_1.data))).html);
