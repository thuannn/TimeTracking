...
function $onSuccess_36(this$static){
  $equals_5((dynamicCast(this$static.this$0.view, Q$TimeInputPresenter$MyView) , 'log-updated'), 'log-updated') && undefined;
}
...
_.success = function success_11(presenter){
  $success_9(this, dynamicCast(presenter, Q$TimeInputPresenter));
}
;
_.val$event = null;
...
;
_.castableTypeMap$ = makeCastMap([Q$TimeInputPresenter$MyView]);
_.lblProfName = null;
_.logProvider = null;
_.lstCourses = null;
_.lstMonth = null;
...
_.onCellPreview = function onCellPreview_0(event_0){
  var isClick, isKeyDown, evt;
  isClick = $equals_5('click', event_0.nativeEvent.type);
  isKeyDown = $equals_5('keydown', event_0.nativeEvent.type);
  (isClick || isKeyDown && (event_0.nativeEvent.keyCode || 0) == 8) && $dispatchEvent($getRowElement(this.this$0.tblLog, event_0.context.index_0).cells[event_0.context.column], (evt = $doc.createEventObject() , evt.type = 'click' , evt.detail = 1 , evt.screenX = 0 , evt.screenY = 0 , evt.clientX = 0 , evt.clientY = 0 , evt.ctrlKey = false , evt.altKey = false , evt.shiftKey = false , evt.metaKey = false , evt.button = 1 , evt.relatedTarget = null , evt));
}
;
...
function LogRequestFactory_LogRequestContextImpl$10X(){
}

_ = LogRequestFactory_LogRequestContextImpl$10X_0.prototype = LogRequestFactory_LogRequestContextImpl$10X.prototype = new AbstractRequest;
_.getClass$ = function getClass_817(){
  return Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$10X_2_classLit;
}
;
...
function LogTypeRequestFactory_LogTypeRequestContextImpl$3X(){
}

_ = LogTypeRequestFactory_LogTypeRequestContextImpl$3X_0.prototype = LogTypeRequestFactory_LogTypeRequestContextImpl$3X.prototype = new AbstractRequest;
_.getClass$ = function getClass_826(){
  return Lcom_lemania_timetracking_shared_service_LogTypeRequestFactory_1LogTypeRequestContextImpl$3X_2_classLit;
}
;
