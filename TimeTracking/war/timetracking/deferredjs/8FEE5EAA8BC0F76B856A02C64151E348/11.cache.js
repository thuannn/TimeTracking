...
defineSeed(806, 663, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$RptTimeByDepartmentPresenter, Q$RptTimeByDepartmentUiHandler]), RptTimeByDepartmentPresenter_0);
...
defineSeed(807, 602, makeCastMap([Q$Receiver]), RptTimeByDepartmentPresenter$1_0);
...
defineSeed(808, 602, makeCastMap([Q$Receiver]), RptTimeByDepartmentPresenter$2_0);
...
defineSeed(1005, 668, makeCastMap([Q$IsWidget, Q$RptTimeByDepartmentPresenter$MyView, Q$RptTimeByDepartmentView]), RptTimeByDepartmentView_0);
...
defineSeed(1006, 1, {}, RptTimeByDepartmentView_BinderImpl_0);
...
defineSeed(1007, 1, {}, RptTimeByDepartmentView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1008, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), RptTimeByDepartmentView_BinderImpl$Widgets$1_0);
...
defineSeed(1139, 606, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$6X_0);
...
_.val$deptId = null;
_.val$year = 0;
var Lcom_lemania_timetracking_client_presenter_RptTimeByDepartmentPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByDepartmentPresenter', 806), Lcom_lemania_timetracking_client_presenter_RptTimeByDepartmentPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByDepartmentPresenter$1', 807), Lcom_lemania_timetracking_client_presenter_RptTimeByDepartmentPresenter$2_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByDepartmentPresenter$2', 808), Lcom_lemania_timetracking_client_view_RptTimeByDepartmentView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByDepartmentView', 1005), Lcom_lemania_timetracking_client_view_RptTimeByDepartmentView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByDepartmentView_BinderImpl', 1006), Lcom_lemania_timetracking_client_view_RptTimeByDepartmentView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByDepartmentView_BinderImpl$Widgets', 1007), Lcom_lemania_timetracking_client_view_RptTimeByDepartmentView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByDepartmentView_BinderImpl$Widgets$1', 1008), Lcom_lemania_timetracking_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$6X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$6X', 1139);
$entry(onLoad)(11);
