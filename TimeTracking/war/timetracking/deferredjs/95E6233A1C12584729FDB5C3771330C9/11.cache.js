...
defineSeed(809, 666, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$RptTimeByMonthPresenter, Q$RptTimeByMonthUiHandler]), RptTimeByMonthPresenter_0);
...
defineSeed(810, 605, makeCastMap([Q$Receiver]), RptTimeByMonthPresenter$1_0);
...
defineSeed(996, 671, makeCastMap([Q$IsWidget, Q$RptTimeByMonthPresenter$MyView]), RptTimeByMonthView_0);
...
defineSeed(1108, 609, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$8X_0);
