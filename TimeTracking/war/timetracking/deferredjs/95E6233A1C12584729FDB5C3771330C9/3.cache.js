...
defineSeed(738, 666, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(739, 605, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(740, 605, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(741, 605, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(742, 605, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(905, 671, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(906, 350, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(908, 350, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1093, 609, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
