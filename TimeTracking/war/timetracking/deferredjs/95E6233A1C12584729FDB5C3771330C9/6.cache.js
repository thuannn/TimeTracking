...
defineSeed(720, 229, {}, CoursesLoadedEvent_0);
...
function $loadProfessorList(this$static, courses){
  ...
  $fire((x = new ProfessorRequestFactory_ProfessorRequestContextImpl$4X_0(rc, courses) , $addInvocation(rc.state.dialect, x) , x), new RptTimeByProfPresenter$2_0(this$static));
}
...
function $onDepartmentSelected_0(this$static, deptId){
  ...
  $initialize(rf, this$static.eventBus, new EventSourceRequestTransport_0(this$static.eventBus));
  rc = new ProfessorRequestFactory_ProfessorRequestContextImpl_0(rf);
  $fire($listAllByCourse(rc, deptId), new RptTimeByProfPresenter$3_0(this$static));
}
...
defineSeed(815, 666, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursesLoadedEvent$CoursesLoadedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$RptTimeByProfPresenter, Q$ExtractDataUiHandler]), RptTimeByProfPresenter_0);
...
defineSeed(816, 605, makeCastMap([Q$Receiver]), RptTimeByProfPresenter$1_0);
...
defineSeed(817, 605, makeCastMap([Q$Receiver]), RptTimeByProfPresenter$2_0);
...
defineSeed(818, 605, makeCastMap([Q$Receiver]), RptTimeByProfPresenter$3_0);
...
defineSeed(819, 605, makeCastMap([Q$Receiver]), RptTimeByProfPresenter$4_0);
...
;
_.this$0 = null;
defineSeed(820, 697, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$CoursesLoadedEvent$CoursesLoadedHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler]));
...
defineSeed(823, 679, {}, RptTimeByProfPresenterMyProxyImpl$2_0);
_.success = function success_12(presenter){
  $success_10(this, dynamicCast(presenter, Q$RptTimeByProfPresenter));
}
;
_.val$event = null;
...
defineSeed(824, 1, {}, RptTimeByProfPresenterMyProxyImpl$2$1_0);
...
function RptTimeByProfView_0(){
  this.widget = $build_f_HTMLPanel1_11(new RptTimeByProfView_BinderImpl$Widgets_0(this));
}

defineSeed(1002, 671, makeCastMap([Q$IsWidget, Q$RptTimeByProfPresenter$MyView, Q$RptTimeByProfView]), RptTimeByProfView_0);
...
defineSeed(1003, 1, {}, RptTimeByProfView_BinderImpl_0);
...
defineSeed(1004, 1, {}, RptTimeByProfView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1005, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), RptTimeByProfView_BinderImpl$Widgets$1_0);
...
defineSeed(1006, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), RptTimeByProfView_BinderImpl$Widgets$2_0);
...
defineSeed(1109, 609, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$9X_0);
...
;
_.val$deptId = null;
function ProfessorRequestFactory_ProfessorRequestContextImpl$4X_0(this$0, val$courses){
  this.val$courses = val$courses;
  AbstractRequest_0.call(this, this$0);
}

defineSeed(1121, 609, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$4X_0);
...
;
_.val$courses = null;
var Lcom_lemania_timetracking_client_presenter_RptTimeByProfPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByProfPresenter', 815), Lcom_lemania_timetracking_client_presenter_RptTimeByProfPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByProfPresenter$1', 816), Lcom_lemania_timetracking_client_presenter_RptTimeByProfPresenter$2_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByProfPresenter$2', 817), Lcom_lemania_timetracking_client_presenter_RptTimeByProfPresenter$3_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByProfPresenter$3', 818), Lcom_lemania_timetracking_client_presenter_RptTimeByProfPresenter$4_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByProfPresenter$4', 819), Lcom_lemania_timetracking_client_event_CoursesLoadedEvent_2_classLit = createForClass('com.lemania.timetracking.client.event.', 'CoursesLoadedEvent', 720), Lcom_lemania_timetracking_client_presenter_RptTimeByProfPresenterMyProxyImpl$2_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByProfPresenterMyProxyImpl$2', 823), Lcom_lemania_timetracking_client_presenter_RptTimeByProfPresenterMyProxyImpl$2$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByProfPresenterMyProxyImpl$2$1', 824), Lcom_lemania_timetracking_client_view_RptTimeByProfView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByProfView', 1002), Lcom_lemania_timetracking_client_view_RptTimeByProfView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByProfView_BinderImpl', 1003), Lcom_lemania_timetracking_client_view_RptTimeByProfView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByProfView_BinderImpl$Widgets', 1004), Lcom_lemania_timetracking_client_view_RptTimeByProfView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByProfView_BinderImpl$Widgets$1', 1005), Lcom_lemania_timetracking_client_view_RptTimeByProfView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByProfView_BinderImpl$Widgets$2', 1006), Lcom_lemania_timetracking_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$4X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$4X', 1121), Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$9X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'LogRequestFactory_LogRequestContextImpl$9X', 1109);
$entry(onLoad)(6);
