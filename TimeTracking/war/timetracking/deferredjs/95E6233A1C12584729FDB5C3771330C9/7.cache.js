...
defineSeed(758, 666, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(759, 605, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(760, 605, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(928, 671, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1134, 609, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$2X_0);
