...
defineSeed(785, 674, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LogTypeAddedEvent$LogTypeAddedHandler, Q$LogTypesPresenter, Q$LogTypeListUiHandler]), LogTypesPresenter_0);
...
defineSeed(786, 613, makeCastMap([Q$Receiver]), LogTypesPresenter$1_0);
...
defineSeed(787, 613, makeCastMap([Q$Receiver]), LogTypesPresenter$2_0);
...
defineSeed(788, 613, makeCastMap([Q$Receiver]), LogTypesPresenter$3_0);
...
defineSeed(789, 613, makeCastMap([Q$Receiver]), LogTypesPresenter$4_0);
...
defineSeed(961, 679, makeCastMap([Q$IsWidget, Q$LogTypesPresenter$MyView]), LogTypesView_0);
...
defineSeed(1112, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$LogTypeProxy]));
...
;
defineSeed(1113, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$LogTypeProxy]));
...
defineSeed(1153, 617, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$2X_0);
...
defineSeed(1155, 617, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$6X_0);
