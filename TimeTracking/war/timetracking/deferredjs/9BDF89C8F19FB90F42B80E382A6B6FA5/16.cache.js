...
defineSeed(721, 228, {}, LogTypeAddedEvent_0);
...
defineSeed(770, 663, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$HourAddUiHandler]), LogTypesAddPresenter_0);
...
defineSeed(771, 602, makeCastMap([Q$Receiver]), LogTypesAddPresenter$1_0);
...
;
_.this$0 = null;
defineSeed(779, 695, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LogTypeAddedEvent$LogTypeAddedHandler]));
...
defineSeed(780, 677, {}, LogTypesPresenterMyProxyImpl$1_0);
...
defineSeed(944, 668, makeCastMap([Q$IsWidget, Q$LogTypesAddPresenter$MyView]), LogTypesAddView_0);
...
defineSeed(945, 1, {}, LogTypesAddView_BinderImpl_0);
...
defineSeed(946, 1, {}, LogTypesAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(947, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), LogTypesAddView_BinderImpl$Widgets$1_0);
...
defineSeed(948, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), LogTypesAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1143, 606, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$5X_0);
