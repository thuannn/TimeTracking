...
defineSeed(737, 663, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(738, 602, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(739, 602, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(740, 602, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(741, 602, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(909, 668, makeCastMap([Q$IsWidget, Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(1122, 606, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
