...
defineSeed(783, 685, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(784, 624, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(785, 624, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(786, 624, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(787, 624, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(912, 690, makeCastMap([Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(913, 353, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(915, 353, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1105, 628, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
