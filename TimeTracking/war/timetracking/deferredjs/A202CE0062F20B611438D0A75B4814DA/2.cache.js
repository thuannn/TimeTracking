...
defineSeed(868, 685, makeCastMap([Q$HasHandlers, Q$PresenterWidget]), RptTimeBySchoolPresenter_0);
...
defineSeed(869, 624, makeCastMap([Q$Receiver]), RptTimeBySchoolPresenter$1_0);
...
defineSeed(1016, 690, makeCastMap([Q$RptTimeBySchoolPresenter$MyView, Q$RptTimeBySchoolView]), RptTimeBySchoolView_0);
...
defineSeed(1017, 396, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$1_0);
...
defineSeed(1018, 396, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$10_0);
...
defineSeed(1019, 396, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$11_0);
...
defineSeed(1020, 396, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$12_0);
...
defineSeed(1021, 396, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$13_0);
...
defineSeed(1022, 396, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$2_0);
...
defineSeed(1023, 396, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$3_0);
...
defineSeed(1024, 396, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$4_0);
...
defineSeed(1025, 396, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$5_0);
...
defineSeed(1026, 396, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$6_0);
...
defineSeed(1027, 396, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$7_0);
...
defineSeed(1028, 396, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$8_0);
...
defineSeed(1029, 396, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$9_0);
