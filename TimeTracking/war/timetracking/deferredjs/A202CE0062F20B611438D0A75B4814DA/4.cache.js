...
defineSeed(872, 685, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(873, 624, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(874, 624, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(875, 624, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
function $populateCurrentSettings(this$static, settingOptions){
  ...
  for (setting$iterator = settingOptions.iterator(); setting$iterator.hasNext();) {
    ...
    $equals_4(setting.getOptionName(), 'BLOCK') && $setValue_1(this$static.blnBlock, ($clinit_Boolean() , $clinit_Boolean() , $equalsIgnoreCase('true', setting.getOptionValue())?TRUE_1:FALSE_1));
  }
}
...
defineSeed(1033, 690, makeCastMap([Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1142, 628, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
