...
defineSeed(862, 685, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$RptTimeByMonthPresenter, Q$RptTimeByMonthUiHandler]), RptTimeByMonthPresenter_0);
...
defineSeed(863, 624, makeCastMap([Q$Receiver]), RptTimeByMonthPresenter$1_0);
...
function $setLogData_0(this$static, logs){
  ...
  for (i = 0; i < logs.size_1(); ++i) {
    ...
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), 'Cours') && (currentCol = 2);
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), 'Maladie/ACC') && (currentCol = 3);
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), 'F\xE9ri\xE9s') && (currentCol = 4);
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), 'Priv\xE9') && (currentCol = 5);
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), 'Supervision') && (currentCol = 6);
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), 'Frais') && (currentCol = 8);
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), 'Frais') || (totalHour = totalHour + dynamicCast(logs.get_0(i), Q$LogProxy).getHour());
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), 'Frais') && (totalCash = totalCash + dynamicCast(logs.get_0(i), Q$LogProxy).getHour());
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), 'Frais')?$setText(this$static.tblProfs, currentRow, currentCol, dynamicCast(logs.get_0(i), Q$LogProxy).getHour() > 0?'CHF ' + dynamicCast(logs.get_0(i), Q$LogProxy).getHour():''):$setText(this$static.tblProfs, currentRow, currentCol, dynamicCast(logs.get_0(i), Q$LogProxy).getHour() > 0?'' + dynamicCast(logs.get_0(i), Q$LogProxy).getHour():'');
...
defineSeed(1010, 690, makeCastMap([Q$RptTimeByMonthPresenter$MyView]), RptTimeByMonthView_0);
...
defineSeed(1011, 1, {}, RptTimeByMonthView_BinderImpl_0);
function $build_f_HTMLPanel1_11(this$static){
  var attachRecord16, f_HTMLPanel1, f_FlowPanel2, f_VerticalPanel3, f_Label4, f_HorizontalPanel5, f_Label6, lstYear, f_Label7, lstMonth, tblProfs;
...
defineSeed(1012, 1, {}, RptTimeByMonthView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1013, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), RptTimeByMonthView_BinderImpl$Widgets$1_0);
...
defineSeed(1014, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), RptTimeByMonthView_BinderImpl$Widgets$2_0);
...
defineSeed(1121, 628, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$7X_0);
...
var Lcom_lemania_timetracking_client_presenter_RptTimeByMonthPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByMonthPresenter', 862), Lcom_lemania_timetracking_client_presenter_RptTimeByMonthPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByMonthPresenter$1', 863), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView', 1010), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView_BinderImpl', 1011), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView_BinderImpl$Widgets', 1012), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView_BinderImpl$Widgets$1', 1013), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView_BinderImpl$Widgets$2', 1014), Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$7X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'LogRequestFactory_LogRequestContextImpl$7X', 1121);
$entry(onLoad)(5);
