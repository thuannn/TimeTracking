...
defineSeed(770, 672, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$AfterUserLogOutEvent$AfterUserLogOutHandler, Q$HomePresenter, Q$HomeUiHandler]), HomePresenter_0);
...
defineSeed(771, 611, makeCastMap([Q$Receiver]), HomePresenter$1_0);
...
defineSeed(772, 611, makeCastMap([Q$Receiver]), HomePresenter$2_0);
...
defineSeed(948, 677, makeCastMap([Q$IsWidget, Q$HomePresenter$MyView]), HomeView_0);
...
defineSeed(1161, 615, makeCastMap([Q$AbstractRequest]), UserRequestFactory_UserRequestContextImpl$2X_0);
