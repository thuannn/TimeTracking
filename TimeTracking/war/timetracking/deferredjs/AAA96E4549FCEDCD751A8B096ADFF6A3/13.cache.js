...
defineSeed(834, 676, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(835, 615, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(836, 615, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(837, 615, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1029, 681, makeCastMap([Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1030, 1, {}, SettingsView_BinderImpl_0);
...
defineSeed(1031, 1, {}, SettingsView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1032, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), SettingsView_BinderImpl$Widgets$1_0);
...
defineSeed(1132, 619, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
