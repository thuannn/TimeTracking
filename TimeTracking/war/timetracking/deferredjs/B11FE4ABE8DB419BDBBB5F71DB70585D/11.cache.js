...
defineSeed(811, 663, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$RptTimeByMonthPresenter, Q$RptTimeByMonthUiHandler]), RptTimeByMonthPresenter_0);
...
defineSeed(812, 602, makeCastMap([Q$Receiver]), RptTimeByMonthPresenter$1_0);
...
defineSeed(858, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(993, 668, makeCastMap([Q$RptTimeByMonthPresenter$MyView]), RptTimeByMonthView_0);
...
defineSeed(994, 1, {}, RptTimeByMonthView_BinderImpl_0);
function $build_f_HTMLPanel1_11(this$static){
  ...
  $addAndReplaceElement(f_HTMLPanel1, (f_FlowPanel2 = new FlowPanel_0 , $add_4(f_FlowPanel2, (f_VerticalPanel3 = new VerticalPanel_0 , $setHorizontalAlignment_0(f_VerticalPanel3, ($clinit_HasHorizontalAlignment() , ALIGN_LEFT)) , $add_8(f_VerticalPanel3, (f_Label4 = new Label_0 , f_Label4.element['className'] = 'pageTitle' , $setTextOrHtml(f_Label4.directionalTextHelper, 'RAPPORT DES HEURES PAR MOIS', false) , $updateHorizontalAlignment(f_Label4) , f_Label4.element.style['height'] = '30' , f_Label4.element.style['width'] = '830' , f_Label4)) , $add_8(f_VerticalPanel3, (f_HorizontalPanel5 = new HorizontalPanel_0 , $setVerticalAlignment(f_HorizontalPanel5, ($clinit_HasVerticalAlignment() , ALIGN_MIDDLE)) , $add_6(f_HorizontalPanel5, (f_Label6 = new Label_0 , $setTextOrHtml(f_Label6.directionalTextHelper, 'Choisir une ann\xE9e :', false) , $updateHorizontalAlignment(f_Label6) , f_Label6)) , $add_6(f_HorizontalPanel5, (lstYear = new ListBox_0 , $addDomHandler(lstYear, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, ($clinit_ChangeEvent() , $clinit_ChangeEvent() , TYPE)) , this$static.owner.lstYear = lstYear , lstYear)) , $add_6(f_HorizontalPanel5, (f_Label7 = new Label_0 , $setTextOrHtml(f_Label7.directionalTextHelper, 'Choisir un mois :', false) , $updateHorizontalAlignment(f_Label7) , f_Label7)) , $add_6(f_HorizontalPanel5, (lstMonth = new ListBox_0 , $addDomHandler(lstMonth, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2, TYPE) , this$static.owner.lstMonth = lstMonth , lstMonth)) , f_HorizontalPanel5.element.style['width'] = '80%' , f_HorizontalPanel5.table['cellSpacing'] = 2 , f_HorizontalPanel5)) , $add_8(f_VerticalPanel3, (tblProfs = new FlexTable_0 , tblProfs.element.style['height'] = '100%' , tblProfs.element.style['width'] = '100%' , this$static.owner.tblProfs = tblProfs , tblProfs)) , f_VerticalPanel3.element.style['height'] = '' , f_VerticalPanel3.element.style['width'] = '100%' , f_VerticalPanel3.table['cellSpacing'] = 2 , f_VerticalPanel3)) , f_FlowPanel2.element.style['height'] = '' , f_FlowPanel2.element.style['width'] = '' , f_FlowPanel2), $get_1(this$static.domId0Element));
  return f_HTMLPanel1;
}
...
defineSeed(995, 1, {}, RptTimeByMonthView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(996, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), RptTimeByMonthView_BinderImpl$Widgets$1_0);
...
defineSeed(997, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), RptTimeByMonthView_BinderImpl$Widgets$2_0);
...
defineSeed(1099, 606, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$8X_0);
...
var Lcom_lemania_timetracking_client_presenter_RptTimeByMonthPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByMonthPresenter', 811), Lcom_lemania_timetracking_client_presenter_RptTimeByMonthPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByMonthPresenter$1', 812), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView', 993), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView_BinderImpl', 994), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView_BinderImpl$Widgets', 995), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView_BinderImpl$Widgets$1', 996), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView_BinderImpl$Widgets$2', 997), Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$8X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'LogRequestFactory_LogRequestContextImpl$8X', 1099);
$entry(onLoad)(11);
