...
defineSeed(771, 663, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LogTypeAddedEvent$LogTypeAddedHandler, Q$LogTypesPresenter, Q$LogTypeListUiHandler]), LogTypesPresenter_0);
...
defineSeed(772, 602, makeCastMap([Q$Receiver]), LogTypesPresenter$1_0);
...
defineSeed(773, 602, makeCastMap([Q$Receiver]), LogTypesPresenter$2_0);
...
defineSeed(774, 602, makeCastMap([Q$Receiver]), LogTypesPresenter$3_0);
...
defineSeed(775, 602, makeCastMap([Q$Receiver]), LogTypesPresenter$4_0);
...
defineSeed(938, 668, makeCastMap([Q$LogTypesPresenter$MyView]), LogTypesView_0);
...
defineSeed(1064, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$LogTypeProxy]));
...
;
defineSeed(1065, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$LogTypeProxy]));
...
defineSeed(1104, 606, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$2X_0);
...
defineSeed(1106, 606, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$6X_0);
