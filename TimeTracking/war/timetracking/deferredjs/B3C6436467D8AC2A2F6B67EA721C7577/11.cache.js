...
function $onMonthChanged(this$static, selectedYear, selectedMonth){
  ...
  $fire((x = new LogRequestFactory_LogRequestContextImpl$7X_0(rcl, selectedYear, selectedMonth) , $addInvocation(rcl.state.dialect, x) , x), new RptTimeByMonthPresenter$1_0(this$static));
}
...
defineSeed(834, 686, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$RptTimeByMonthPresenter, Q$RptTimeByMonthUiHandler]), RptTimeByMonthPresenter_0);
...
defineSeed(835, 625, makeCastMap([Q$Receiver]), RptTimeByMonthPresenter$1_0);
...
;
_.this$0 = null;
function $com$lemania$timetracking$client$presenter$RptTimeByMonthPresenter_com$lemania$timetracking$client$presenter$RptTimeByMonthPresenter_methodInjection(_0, _1){
...
function $get_Key$type$com$lemania$timetracking$client$presenter$RptTimeByMonthPresenter$_annotation$$none$$(this$static){
  ...
  if (!this$static.singleton_Key$type$com$lemania$timetracking$client$presenter$RptTimeByMonthPresenter$_annotation$$none$$) {
    result = $com$lemania$timetracking$client$presenter$RptTimeByMonthPresenter_com$lemania$timetracking$client$presenter$RptTimeByMonthPresenter_methodInjection($get_Key$type$com$google$web$bindery$event$shared$EventBus$_annotation$$none$$($getFragment_com_google_web_bindery_event_shared(this$static.injector)), $get_Key$type$com$lemania$timetracking$client$view$RptTimeByMonthView$_annotation$$none$$($getFragment_com_lemania_timetracking_client_view(this$static.injector)), $get_Key$type$com$lemania$timetracking$client$presenter$RptTimeByMonthPresenter$MyProxy$_annotation$$none$$(this$static));
...
function $onLstMonthChanged(this$static){
  $removeAllRows(this$static.tblProfs);
  if ($equals_4($getValue_1(this$static.lstMonth, this$static.lstMonth.element.selectedIndex), ''))
    return;
...
function $setLogData_0(this$static, logs){
  ...
  for (i = 0; i < logs.size_1(); ++i) {
    if (!$equals_4(prevProf, dynamicCast(logs.get_0(i), Q$LogProxy).getProfName())) {
      currentRow = i + 1;
      if (currentRow > 1) {
    ...
    if (!$equals_4(prevDept, dynamicCast(logs.get_0(i), Q$LogProxy).getCourseName())) {
      currentRow = i + 1;
      if ($equals_4(prevProf, dynamicCast(logs.get_0(i), Q$LogProxy).getProfName())) {
        totalProf = totalProf + totalHour;
        totalProfCash = totalProfCash + totalCash;
      }
      if (!$equals_4(prevProf, dynamicCast(logs.get_0(i), Q$LogProxy).getProfName()) && currentRow > 1) {
        currentRow = currentRow + 1;
        for (k = 0; k < 10; ++k) {
          $setText(this$static.tblProfs, currentRow, 0, '');
          $addStyleName(this$static.tblProfs.cellFormatter, currentRow, k, 'FlexTable-Cell-Divider');
    ...
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), '1.Cours') && (currentCol = 2);
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), '2.Maladie/ACC') && (currentCol = 3);
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), '3.F\xE9ri\xE9s') && (currentCol = 4);
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), '4.Priv\xE9') && (currentCol = 5);
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), '5.Supervision') && (currentCol = 6);
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), '6.Frais') && (currentCol = 8);
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), '6.Frais') || (totalHour = totalHour + dynamicCast(logs.get_0(i), Q$LogProxy).getHour());
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), '6.Frais') && (totalCash = totalCash + dynamicCast(logs.get_0(i), Q$LogProxy).getHour());
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getTypeName(), '6.Frais')?$setText(this$static.tblProfs, currentRow, currentCol, dynamicCast(logs.get_0(i), Q$LogProxy).getHour() > 0?'CHF ' + dynamicCast(logs.get_0(i), Q$LogProxy).getHour():''):$setText(this$static.tblProfs, currentRow, currentCol, dynamicCast(logs.get_0(i), Q$LogProxy).getHour() > 0?'' + dynamicCast(logs.get_0(i), Q$LogProxy).getHour():'');
    $setText(this$static.tblProfs, currentRow, 7, '' + totalHour);
    $equals_4(dynamicCast(logs.get_0(i), Q$LogProxy).getMemo(), '') || (currentMemo = dynamicCast(logs.get_0(i), Q$LogProxy).getMemo() + '. ' + currentMemo);
...
function $styleTable_1(this$static){
  ...
  for (j = 0; j < this$static.tblProfs.bodyElem.rows.length; ++j) {
    for (k = 0; k < $getCellCount(this$static.tblProfs, j); ++k) {
      $equals_4($getPropertyString($getElement(this$static.tblProfs.cellFormatter, j, k), 'className'), '') && $addStyleName(this$static.tblProfs.cellFormatter, j, k, 'FlexTable-Cell');
    }
  }
}
...
defineSeed(1018, 691, makeCastMap([Q$RptTimeByMonthPresenter$MyView]), RptTimeByMonthView_0);
...
defineSeed(1019, 1, {}, RptTimeByMonthView_BinderImpl_0);
function $build_f_HTMLPanel1_11(this$static){
  var attachRecord10, f_HTMLPanel1, f_FlowPanel2, f_VerticalPanel3, f_Label4, f_HorizontalPanel5, f_Label6, lstYear, f_Label7, lstMonth, tblProfs;
  ...
  $addAndReplaceElement(f_HTMLPanel1, (f_FlowPanel2 = new FlowPanel_0 , $add_4(f_FlowPanel2, (f_VerticalPanel3 = new VerticalPanel_0 , $setHorizontalAlignment_0(f_VerticalPanel3, ($clinit_HasHorizontalAlignment() , ALIGN_LEFT)) , $add_8(f_VerticalPanel3, (f_Label4 = new Label_0 , f_Label4.element['className'] = 'pageTitle' , $setTextOrHtml(f_Label4.directionalTextHelper, 'Informations des heures par mois') , $updateHorizontalAlignment(f_Label4) , f_Label4.element.style['height'] = '30' , f_Label4.element.style['width'] = '830' , f_Label4)) , $add_8(f_VerticalPanel3, (f_HorizontalPanel5 = new HorizontalPanel_0 , $setVerticalAlignment(f_HorizontalPanel5, ($clinit_HasVerticalAlignment() , ALIGN_MIDDLE)) , $add_6(f_HorizontalPanel5, (f_Label6 = new Label_0 , $setTextOrHtml(f_Label6.directionalTextHelper, 'Ann\xE9e :') , $updateHorizontalAlignment(f_Label6) , f_Label6)) , $add_6(f_HorizontalPanel5, (lstYear = new ListBox_0 , $addDomHandler(lstYear, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, ($clinit_ChangeEvent() , $clinit_ChangeEvent() , TYPE)) , this$static.owner.lstYear = lstYear , lstYear)) , $add_6(f_HorizontalPanel5, (f_Label7 = new Label_0 , $setTextOrHtml(f_Label7.directionalTextHelper, 'Mois :') , $updateHorizontalAlignment(f_Label7) , f_Label7)) , $add_6(f_HorizontalPanel5, (lstMonth = new ListBox_0 , $addDomHandler(lstMonth, this$static.handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames2, TYPE) , this$static.owner.lstMonth = lstMonth , lstMonth)) , f_HorizontalPanel5.element.style['width'] = '80%' , f_HorizontalPanel5.table['cellSpacing'] = 2 , f_HorizontalPanel5)) , $add_8(f_VerticalPanel3, (tblProfs = new FlexTable_0 , tblProfs.element.style['height'] = '100%' , tblProfs.element.style['width'] = '100%' , this$static.owner.tblProfs = tblProfs , tblProfs)) , f_VerticalPanel3.element.style['height'] = '' , f_VerticalPanel3.element.style['width'] = '100%' , f_VerticalPanel3.table['cellSpacing'] = 2 , f_VerticalPanel3)) , f_FlowPanel2.element.style['height'] = '' , f_FlowPanel2.element.style['width'] = '' , f_FlowPanel2), $get_1(this$static.domId0Element));
  return f_HTMLPanel1;
}
...
defineSeed(1020, 1, {}, RptTimeByMonthView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1021, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), RptTimeByMonthView_BinderImpl$Widgets$1_0);
...
defineSeed(1022, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), RptTimeByMonthView_BinderImpl$Widgets$2_0);
...
function LogRequestFactory_LogRequestContextImpl$7X_0(this$0, val$selectedYear, val$selectedMonth){
  this.val$selectedYear = val$selectedYear;
  this.val$selectedMonth = val$selectedMonth;
  AbstractRequest_0.call(this, this$0);
}

defineSeed(1130, 629, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$7X_0);
...
var Lcom_lemania_timetracking_client_presenter_RptTimeByMonthPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByMonthPresenter', 834), Lcom_lemania_timetracking_client_presenter_RptTimeByMonthPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByMonthPresenter$1', 835), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView', 1018), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView_BinderImpl', 1019), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView_BinderImpl$Widgets', 1020), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView_BinderImpl$Widgets$1', 1021), Lcom_lemania_timetracking_client_view_RptTimeByMonthView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByMonthView_BinderImpl$Widgets$2', 1022), Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$7X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'LogRequestFactory_LogRequestContextImpl$7X', 1130);
$entry(onLoad)(11);
