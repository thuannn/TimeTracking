...
defineSeed(844, 686, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(845, 625, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(846, 625, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(847, 625, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1041, 691, makeCastMap([Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1042, 1, {}, SettingsView_BinderImpl_0);
...
defineSeed(1043, 1, {}, SettingsView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(1044, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), SettingsView_BinderImpl$Widgets$1_0);
...
defineSeed(1151, 629, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
