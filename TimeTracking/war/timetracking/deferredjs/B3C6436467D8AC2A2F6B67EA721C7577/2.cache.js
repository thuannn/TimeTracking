...
defineSeed(737, 223, {}, CoursAddedEvent_0);
...
defineSeed(750, 686, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(751, 625, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(752, 625, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(760, 715, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$Place, Q$CoursAddedEvent$CoursAddedHandler]));
...
defineSeed(761, 699, {}, CoursPresenterMyProxyImpl$1_0);
...
defineSeed(762, 1, {}, CoursPresenterMyProxyImpl$1$1_0);
...
defineSeed(914, 691, makeCastMap([Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(1113, 629, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
