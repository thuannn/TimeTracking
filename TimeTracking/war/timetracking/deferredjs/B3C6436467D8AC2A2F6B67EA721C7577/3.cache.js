...
defineSeed(755, 686, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(756, 625, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(757, 625, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(758, 625, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(759, 625, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(920, 691, makeCastMap([Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(921, 353, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(923, 353, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1114, 629, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
