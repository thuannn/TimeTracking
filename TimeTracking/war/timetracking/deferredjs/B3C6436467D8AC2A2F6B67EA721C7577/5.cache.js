...
defineSeed(768, 686, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$EcoleAddedEvent$EcoleAddedHandler, Q$EcolePresenter, Q$EcoleListUiHandler]), EcolePresenter_0);
...
defineSeed(769, 625, makeCastMap([Q$Receiver]), EcolePresenter$1_0);
...
defineSeed(770, 625, makeCastMap([Q$Receiver]), EcolePresenter$2_0);
...
defineSeed(935, 691, makeCastMap([Q$EcolePresenter$MyView]), EcoleView_0);
...
defineSeed(936, 396, makeCastMap([Q$HasCell, Q$Column]), EcoleView$1_0);
...
defineSeed(937, 396, makeCastMap([Q$HasCell, Q$Column]), EcoleView$2_0);
...
defineSeed(1121, 629, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$6X_0);
