...
defineSeed(789, 691, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(790, 630, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(791, 630, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(792, 630, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(793, 630, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(918, 696, makeCastMap([Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(919, 357, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(920, 1, {}, CoursView$2_0);
...
defineSeed(921, 357, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(922, 1, {}, CoursView$4_0);
...
defineSeed(923, 1, {}, CoursView_BinderImpl_0);
...
defineSeed(924, 1, {}, CoursView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(925, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), CoursView_BinderImpl$Widgets$1_0);
...
defineSeed(1111, 634, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
...
;
_.val$newCours = null;
var Lcom_lemania_timetracking_client_presenter_CoursPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursPresenter', 789), Lcom_lemania_timetracking_client_presenter_CoursPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursPresenter$1', 790), Lcom_lemania_timetracking_client_presenter_CoursPresenter$2_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursPresenter$2', 791), Lcom_lemania_timetracking_client_presenter_CoursPresenter$3_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursPresenter$3', 792), Lcom_lemania_timetracking_client_presenter_CoursPresenter$4_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursPresenter$4', 793), Lcom_lemania_timetracking_client_view_CoursView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView', 918), Lcom_lemania_timetracking_client_view_CoursView$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView$1', 919), Lcom_lemania_timetracking_client_view_CoursView$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView$2', 920), Lcom_lemania_timetracking_client_view_CoursView$3_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView$3', 921), Lcom_lemania_timetracking_client_view_CoursView$4_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView$4', 922), Lcom_lemania_timetracking_client_view_CoursView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView_BinderImpl', 923), Lcom_lemania_timetracking_client_view_CoursView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView_BinderImpl$Widgets', 924), Lcom_lemania_timetracking_client_view_CoursView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursView_BinderImpl$Widgets$1', 925), Lcom_lemania_timetracking_shared_service_CoursRequestFactory_1CoursRequestContextImpl$8X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'CoursRequestFactory_CoursRequestContextImpl$8X', 1111);
$entry(onLoad)(15);
