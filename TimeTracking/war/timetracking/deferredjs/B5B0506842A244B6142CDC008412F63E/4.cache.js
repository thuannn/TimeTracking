...
defineSeed(878, 691, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(879, 630, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(880, 630, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(881, 630, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1039, 696, makeCastMap([Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1148, 634, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
