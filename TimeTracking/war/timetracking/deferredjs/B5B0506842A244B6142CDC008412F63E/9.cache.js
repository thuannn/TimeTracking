...
defineSeed(740, 227, {}, EcoleAddedEvent_0);
...
defineSeed(779, 1, makeCastMap([Q$RunAsyncCallback]));
...
defineSeed(798, 691, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$EcoleAddUiHandler]), EcoleAddPresenter_0);
...
defineSeed(799, 630, makeCastMap([Q$Receiver]), EcoleAddPresenter$1_0);
...
;
defineSeed(805, 719, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$Place, Q$EcoleAddedEvent$EcoleAddedHandler]));
...
defineSeed(806, 703, {}, EcolePresenterMyProxyImpl$1_0);
...
defineSeed(927, 696, makeCastMap([Q$EcoleAddPresenter$MyView]), EcoleAddView_0);
...
defineSeed(1085, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$EcoleProxy]));
...
defineSeed(1117, 634, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$5X_0);
...
;
_.val$ecole = null;
var Lcom_lemania_timetracking_client_presenter_EcoleAddPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcoleAddPresenter', 798), Lcom_lemania_timetracking_client_presenter_EcoleAddPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcoleAddPresenter$1', 799), Lcom_lemania_timetracking_client_event_EcoleAddedEvent_2_classLit = createForClass('com.lemania.timetracking.client.event.', 'EcoleAddedEvent', 740), Lcom_lemania_timetracking_client_view_EcoleAddView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView', 927), Lcom_lemania_timetracking_client_presenter_EcolePresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcolePresenterMyProxyImpl$1', 806), Lcom_lemania_timetracking_client_presenter_EcolePresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcolePresenterMyProxyImpl$1$1', 807), Lcom_lemania_timetracking_shared_service_EcoleRequestFactory_1EcoleRequestContextImpl$5X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'EcoleRequestFactory_EcoleRequestContextImpl$5X', 1117), Lcom_lemania_timetracking_client_view_EcoleAddView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView_BinderImpl', 928), Lcom_lemania_timetracking_client_view_EcoleAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView_BinderImpl$Widgets', 929), Lcom_lemania_timetracking_client_view_EcoleAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView_BinderImpl$Widgets$1', 930), Lcom_lemania_timetracking_client_view_EcoleAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView_BinderImpl$Widgets$2', 931);
$entry(onLoad)(9);
