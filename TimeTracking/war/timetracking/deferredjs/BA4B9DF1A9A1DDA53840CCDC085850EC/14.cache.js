...
function $createAndBindUi(owner){
  ...
  $setHTML(cmdAnnuler, (sb_0 = new StringBuilder_0 , $append_2(sb_0.data, 'Annuler') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb_0.data))).html);
  $add_6(f_HorizontalPanel9, cmdAnnuler);
  $setHTML(cmdAjouter, (sb_1 = new StringBuilder_0 , $append_2(sb_1.data, 'Ajouter') , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0($toString_0(sb_1.data))).html);
