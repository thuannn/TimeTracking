...
function $updateCoursStatus(this$static, cours, value){
  ...
  $fire((x = new CoursRequestFactory_CoursRequestContextImpl$7X_0(rc, coursForUpdate) , $addInvocation(rc.state.dialect, x) , x), new CoursPresenter$2_0(this$static));
}
...
_ = CoursPresenter_0.prototype = CoursPresenter.prototype = new Presenter;
...
_.val$owner = null;
function CoursRequestFactory_CoursRequestContextImpl$7X_0(this$0, val$newCours){
  this.val$newCours = val$newCours;
  AbstractRequest_0.call(this, this$0);
}

function CoursRequestFactory_CoursRequestContextImpl$7X(){
}

_ = CoursRequestFactory_CoursRequestContextImpl$7X_0.prototype = CoursRequestFactory_CoursRequestContextImpl$7X.prototype = new AbstractRequest;
_.getClass$ = function getClass_783(){
  return Lcom_lemania_timetracking_shared_service_CoursRequestFactory_1CoursRequestContextImpl$7X_2_classLit;
}
;
