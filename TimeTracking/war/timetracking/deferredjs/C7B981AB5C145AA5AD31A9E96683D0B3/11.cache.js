...
defineSeed(815, 672, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$RptTimeByMonthPresenter, Q$RptTimeByMonthUiHandler]), RptTimeByMonthPresenter_0);
...
defineSeed(816, 611, makeCastMap([Q$Receiver]), RptTimeByMonthPresenter$1_0);
...
defineSeed(1002, 677, makeCastMap([Q$IsWidget, Q$RptTimeByMonthPresenter$MyView]), RptTimeByMonthView_0);
...
defineSeed(1114, 615, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$8X_0);
