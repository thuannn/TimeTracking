...
defineSeed(836, 672, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(837, 611, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(838, 611, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(839, 611, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1031, 677, makeCastMap([Q$IsWidget, Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1135, 615, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
...
var Lcom_lemania_timetracking_client_presenter_SettingsPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'SettingsPresenter', 836), Lcom_lemania_timetracking_client_presenter_SettingsPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'SettingsPresenter$1', 837), Lcom_lemania_timetracking_client_presenter_SettingsPresenter$2_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'SettingsPresenter$2', 838), Lcom_lemania_timetracking_client_presenter_SettingsPresenter$3_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'SettingsPresenter$3', 839), Lcom_lemania_timetracking_client_view_SettingsView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'SettingsView', 1031), Lcom_lemania_timetracking_client_view_SettingsView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'SettingsView_BinderImpl', 1032), Lcom_lemania_timetracking_client_view_SettingsView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'SettingsView_BinderImpl$Widgets', 1033), Lcom_lemania_timetracking_client_view_SettingsView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'SettingsView_BinderImpl$Widgets$1', 1034), Lcom_lemania_timetracking_shared_service_SettingOptionRequestFactory_1SettingOptionRequestContextImpl$4X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X', 1135);
$entry(onLoad)(13);
