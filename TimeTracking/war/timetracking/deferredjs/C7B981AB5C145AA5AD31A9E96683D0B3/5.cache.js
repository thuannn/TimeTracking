...
defineSeed(926, 677, makeCastMap([Q$IsWidget, Q$EcolePresenter$MyView]), EcoleView_0);
...
defineSeed(927, 379, makeCastMap([Q$HasCell, Q$Column]), EcoleView$1_0);
...
defineSeed(928, 379, makeCastMap([Q$HasCell, Q$Column]), EcoleView$2_0);
...
defineSeed(929, 353, makeCastMap([Q$HasCell, Q$Column]), EcoleView$3_0);
...
defineSeed(1106, 615, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$6X_0);
