...
defineSeed(792, 672, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ProfessorAddUiHandler]), ProfsAddPresenter_0);
...
defineSeed(793, 611, makeCastMap([Q$Receiver]), ProfsAddPresenter$1_0);
_.onFailure_0 = function onFailure_17(error){
  alert_0(error.message_0);
}
;
_.onSuccess_0 = function onSuccess_17(response){
  $onSuccess_17(this, throwClassCastExceptionUnlessNull(response));
}
;
_.this$0 = null;
...
function ProfsAddView_0(){
  this.widget = $build_f_HTMLPanel1_7(new ProfsAddView_BinderImpl$Widgets_0(this));
}

defineSeed(978, 677, makeCastMap([Q$IsWidget, Q$ProfsAddPresenter$MyView, Q$ProfsAddView]), ProfsAddView_0);
...
defineSeed(979, 1, {}, ProfsAddView_BinderImpl_0);
...
defineSeed(980, 1, {}, ProfsAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(981, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ProfsAddView_BinderImpl$Widgets$1_0);
...
defineSeed(982, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), ProfsAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1129, 615, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$7X_0);
...
;
_.val$prof = null;
var Lcom_lemania_timetracking_client_presenter_ProfsAddPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'ProfsAddPresenter', 792), Lcom_lemania_timetracking_client_presenter_ProfsAddPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'ProfsAddPresenter$1', 793), Lcom_lemania_timetracking_client_view_ProfsAddView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'ProfsAddView', 978), Lcom_lemania_timetracking_client_view_ProfsAddView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'ProfsAddView_BinderImpl', 979), Lcom_lemania_timetracking_client_view_ProfsAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'ProfsAddView_BinderImpl$Widgets', 980), Lcom_lemania_timetracking_client_view_ProfsAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'ProfsAddView_BinderImpl$Widgets$1', 981), Lcom_lemania_timetracking_client_view_ProfsAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'ProfsAddView_BinderImpl$Widgets$2', 982), Lcom_lemania_timetracking_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$7X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$7X', 1129);
$entry(onLoad)(8);
