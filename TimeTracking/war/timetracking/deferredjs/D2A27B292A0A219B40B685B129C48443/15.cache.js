...
defineSeed(729, 227, {}, LogTypeAddedEvent_0);
...
defineSeed(780, 676, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$HourAddUiHandler]), LogTypesAddPresenter_0);
...
defineSeed(781, 615, makeCastMap([Q$Receiver]), LogTypesAddPresenter$1_0);
...
;
_.this$0 = null;
defineSeed(789, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$Place, Q$LogTypeAddedEvent$LogTypeAddedHandler]));
...
defineSeed(790, 689, {}, LogTypesPresenterMyProxyImpl$1_0);
...
defineSeed(791, 1, {}, LogTypesPresenterMyProxyImpl$1$1_0);
...
defineSeed(945, 681, makeCastMap([Q$LogTypesAddPresenter$MyView]), LogTypesAddView_0);
...
defineSeed(1118, 619, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$5X_0);
