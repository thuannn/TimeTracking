...
defineSeed(727, 227, {}, CoursAddedEvent_0);
...
defineSeed(740, 676, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(741, 615, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(742, 615, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(750, 705, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$Place, Q$CoursAddedEvent$CoursAddedHandler]));
...
defineSeed(751, 689, {}, CoursPresenterMyProxyImpl$1_0);
...
defineSeed(752, 1, {}, CoursPresenterMyProxyImpl$1$1_0);
...
defineSeed(903, 681, makeCastMap([Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(1096, 619, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
