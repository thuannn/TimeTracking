...
defineSeed(850, 696, makeCastMap([Q$HasHandlers, Q$PresenterWidget]), RptTimeBySchoolPresenter_0);
...
defineSeed(851, 635, makeCastMap([Q$Receiver]), RptTimeBySchoolPresenter$1_0);
...
defineSeed(1034, 701, makeCastMap([Q$RptTimeBySchoolPresenter$MyView, Q$RptTimeBySchoolView]), RptTimeBySchoolView_0);
...
defineSeed(1035, 399, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$1_0);
...
defineSeed(1036, 399, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$10_0);
...
defineSeed(1037, 399, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$11_0);
...
defineSeed(1038, 399, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$12_0);
...
defineSeed(1039, 399, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$13_0);
...
defineSeed(1040, 399, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$2_0);
...
defineSeed(1041, 399, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$3_0);
...
defineSeed(1042, 399, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$4_0);
...
defineSeed(1043, 399, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$5_0);
...
defineSeed(1044, 399, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$6_0);
...
defineSeed(1045, 399, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$7_0);
...
defineSeed(1046, 399, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$8_0);
...
defineSeed(1047, 399, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$9_0);
