...
defineSeed(854, 696, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(855, 635, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(856, 635, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(857, 635, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1051, 701, makeCastMap([Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1161, 639, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
