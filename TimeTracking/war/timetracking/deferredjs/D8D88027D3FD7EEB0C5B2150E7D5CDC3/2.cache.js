...
defineSeed(747, 221, {}, CoursAddedEvent_0);
...
defineSeed(760, 696, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(761, 635, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(762, 635, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(770, 725, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$Place, Q$CoursAddedEvent$CoursAddedHandler]));
...
defineSeed(771, 709, {}, CoursPresenterMyProxyImpl$1_0);
...
defineSeed(772, 1, {}, CoursPresenterMyProxyImpl$1$1_0);
...
defineSeed(924, 701, makeCastMap([Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(925, 1, {}, CoursAddView_BinderImpl_0);
...
defineSeed(926, 1, {}, CoursAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(927, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$1_0);
...
defineSeed(928, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), CoursAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1123, 639, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
...
_.val$cours = null;
_.val$ecoleId = null;
var Lcom_lemania_timetracking_client_presenter_CoursAddPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursAddPresenter', 760), Lcom_lemania_timetracking_client_presenter_CoursAddPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursAddPresenter$1', 761), Lcom_lemania_timetracking_client_presenter_CoursAddPresenter$2_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursAddPresenter$2', 762), Lcom_lemania_timetracking_client_event_CoursAddedEvent_2_classLit = createForClass('com.lemania.timetracking.client.event.', 'CoursAddedEvent', 747), Lcom_lemania_timetracking_client_presenter_CoursPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursPresenterMyProxyImpl$1', 771), Lcom_lemania_timetracking_client_presenter_CoursPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'CoursPresenterMyProxyImpl$1$1', 772), Lcom_lemania_timetracking_client_view_CoursAddView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursAddView', 924), Lcom_lemania_timetracking_client_view_CoursAddView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursAddView_BinderImpl', 925), Lcom_lemania_timetracking_client_view_CoursAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursAddView_BinderImpl$Widgets', 926), Lcom_lemania_timetracking_client_view_CoursAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursAddView_BinderImpl$Widgets$1', 927), Lcom_lemania_timetracking_client_view_CoursAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'CoursAddView_BinderImpl$Widgets$2', 928), Lcom_lemania_timetracking_shared_service_CoursRequestFactory_1CoursRequestContextImpl$7X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'CoursRequestFactory_CoursRequestContextImpl$7X', 1123);
$entry(onLoad)(2);
