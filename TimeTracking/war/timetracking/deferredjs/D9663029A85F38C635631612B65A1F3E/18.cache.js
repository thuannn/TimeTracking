...
_ = CommonResources_Bundle_ie8_default_InlineClientBundleGenerator_0.prototype = CommonResources_Bundle_ie8_default_InlineClientBundleGenerator.prototype = new Object_0;
_.getClass$ = function getClass_126(){
  return Lcom_google_gwt_resources_client_CommonResources_1Bundle_1ie8_1default_1InlineClientBundleGenerator_2_classLit;
}
;
...
_ = CommonResources_Bundle_ie8_default_InlineClientBundleGenerator$1_0.prototype = CommonResources_Bundle_ie8_default_InlineClientBundleGenerator$1.prototype = new Object_0;
_.getClass$ = function getClass_127(){
  return Lcom_google_gwt_resources_client_CommonResources_1Bundle_1ie8_1default_1InlineClientBundleGenerator$1_2_classLit;
}
;
_.injected = false;
...
function Image_2(resource){
  $clinit_Image();
  Image_3.call(this, resource.url.uri, resource.left_0, resource.top_0, resource.width_0, resource.height);
}
...
_.onUnload = function onUnload_1(){
  ...
  $setValue_1(this, this.attached?($clinit_Boolean() , this.inputElem.checked?TRUE:FALSE):($clinit_Boolean() , this.inputElem.defaultChecked?TRUE:FALSE));
}
;
...
_.setUrlAndVisibleRect = function setUrlAndVisibleRect(image, url, left, top_0, width, height){
  if (!$equals_0(this.url, url) || this.left_0 != left || this.top_0 != top_0 || this.width_0 != width || this.height != height) {
    this.url = url;
    this.left_0 = left;
    this.top_0 = top_0;
    this.width_0 = width;
...
_ = ResizeLayoutPanel$ImplTrident_0.prototype = ResizeLayoutPanel$ImplTrident.prototype = new ResizeLayoutPanel$Impl;
...
_.onUnload = function onUnload_4(){
  $setValue_2(this, $getValue_1(this));
}
;
