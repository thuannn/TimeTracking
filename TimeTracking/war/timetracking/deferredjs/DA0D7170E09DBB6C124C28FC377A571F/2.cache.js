...
_.onUnload = function onUnload_4(){
  $setValue_0(this, $getValue_1(this));
}
;
...
function $createAndBindUi_0(owner){
  ...
  $setValue_0(chkActive, ($clinit_Boolean() , $clinit_Boolean() , TRUE));
...
function $save_0(this$static, ecole){
  var x;
  x = new EcoleRequestFactory_EcoleRequestContextImpl$4X_0(this$static, ecole);
  $addInvocation(this$static.state.dialect, x);
  return x;
}

function EcoleRequestFactory_EcoleRequestContextImpl$4X_0(this$0, val$ecole){
  this.val$ecole = val$ecole;
  AbstractRequest_0.call(this, this$0);
}

function EcoleRequestFactory_EcoleRequestContextImpl$4X(){
}

_ = EcoleRequestFactory_EcoleRequestContextImpl$4X_0.prototype = EcoleRequestFactory_EcoleRequestContextImpl$4X.prototype = new AbstractRequest;
_.getClass$ = function getClass_747(){
  return Lcom_lemania_timetracking_shared_service_EcoleRequestFactory_1EcoleRequestContextImpl$4X_2_classLit;
}
;
