...
defineSeed(750, 233, {}, EcoleAddedEvent_0);
...
defineSeed(777, 693, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$EcoleAddUiHandler]), EcoleAddPresenter_0);
...
defineSeed(778, 629, makeCastMap([Q$Receiver]), EcoleAddPresenter$1_0);
...
defineSeed(785, 707, {}, EcolePresenterMyProxyImpl$1_0);
...
defineSeed(970, 698, makeCastMap([Q$IsWidget, Q$EcoleAddPresenter$MyView]), EcoleAddView_0);
...
defineSeed(971, 1, {}, EcoleAddView_BinderImpl_0);
...
defineSeed(972, 1, {}, EcoleAddView_BinderImpl$Widgets_0);
function EcoleAddView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(973, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), EcoleAddView_BinderImpl$Widgets$1_0);
...
defineSeed(974, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), EcoleAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1160, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$EcoleProxy]));
...
;
defineSeed(1161, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$EcoleProxy]));
...
defineSeed(1197, 633, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$5X_0);
...
;
var Lcom_lemania_timetracking_client_presenter_EcoleAddPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcoleAddPresenter', 777), Lcom_lemania_timetracking_client_presenter_EcoleAddPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcoleAddPresenter$1', 778), Lcom_lemania_timetracking_client_event_EcoleAddedEvent_2_classLit = createForClass('com.lemania.timetracking.client.event.', 'EcoleAddedEvent', 750), Lcom_lemania_timetracking_client_presenter_EcolePresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcolePresenterMyProxyImpl$1', 785), Lcom_lemania_timetracking_client_presenter_EcolePresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcolePresenterMyProxyImpl$1$1', 786), Lcom_lemania_timetracking_client_view_EcoleAddView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView', 970), Lcom_lemania_timetracking_client_view_EcoleAddView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView_BinderImpl', 971), Lcom_lemania_timetracking_client_view_EcoleAddView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView_BinderImpl$Widgets', 972), Lcom_lemania_timetracking_client_view_EcoleAddView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView_BinderImpl$Widgets$1', 973), Lcom_lemania_timetracking_client_view_EcoleAddView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleAddView_BinderImpl$Widgets$2', 974), Lcom_lemania_timetracking_shared_service_EcoleRequestFactory_1EcoleRequestContextImpl$5X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'EcoleRequestFactory_EcoleRequestContextImpl$5X', 1197);
$entry(onLoad)(4);
