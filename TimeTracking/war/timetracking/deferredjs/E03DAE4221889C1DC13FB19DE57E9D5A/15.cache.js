...
defineSeed(719, 229, {}, LogTypeAddedEvent_0);
...
defineSeed(770, 666, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$HourAddUiHandler]), LogTypesAddPresenter_0);
...
defineSeed(771, 605, makeCastMap([Q$Receiver]), LogTypesAddPresenter$1_0);
...
;
_.this$0 = null;
defineSeed(779, 695, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$Place, Q$LogTypeAddedEvent$LogTypeAddedHandler]));
...
defineSeed(780, 679, {}, LogTypesPresenterMyProxyImpl$1_0);
...
defineSeed(781, 1, {}, LogTypesPresenterMyProxyImpl$1$1_0);
...
defineSeed(935, 671, makeCastMap([Q$LogTypesAddPresenter$MyView]), LogTypesAddView_0);
...
defineSeed(1108, 609, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$5X_0);
