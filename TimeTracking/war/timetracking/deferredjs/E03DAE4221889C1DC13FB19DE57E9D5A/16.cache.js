...
defineSeed(774, 666, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LogTypeAddedEvent$LogTypeAddedHandler, Q$LogTypesPresenter, Q$LogTypeListUiHandler]), LogTypesPresenter_0);
...
defineSeed(775, 605, makeCastMap([Q$Receiver]), LogTypesPresenter$1_0);
...
defineSeed(776, 605, makeCastMap([Q$Receiver]), LogTypesPresenter$2_0);
...
defineSeed(777, 605, makeCastMap([Q$Receiver]), LogTypesPresenter$3_0);
...
defineSeed(778, 605, makeCastMap([Q$Receiver]), LogTypesPresenter$4_0);
...
defineSeed(941, 671, makeCastMap([Q$LogTypesPresenter$MyView]), LogTypesView_0);
...
defineSeed(1067, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$LogTypeProxy]));
...
;
defineSeed(1068, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$LogTypeProxy]));
...
defineSeed(1107, 609, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$2X_0);
...
defineSeed(1109, 609, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$6X_0);
