...
defineSeed(795, 666, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ProfsPresenter, Q$ProfessorListUiHandler]), ProfsPresenter_0);
...
defineSeed(796, 605, makeCastMap([Q$Receiver]), ProfsPresenter$1_0);
...
defineSeed(797, 605, makeCastMap([Q$Receiver]), ProfsPresenter$2_0);
...
defineSeed(798, 605, makeCastMap([Q$Receiver]), ProfsPresenter$3_0);
...
defineSeed(799, 605, makeCastMap([Q$Receiver]), ProfsPresenter$4_0);
...
defineSeed(800, 605, makeCastMap([Q$Receiver]), ProfsPresenter$5_0);
...
defineSeed(801, 605, makeCastMap([Q$Receiver]), ProfsPresenter$6_0);
...
defineSeed(802, 605, makeCastMap([Q$Receiver]), ProfsPresenter$7_0);
...
defineSeed(978, 671, makeCastMap([Q$ProfsPresenter$MyView]), ProfsView_0);
...
defineSeed(1054, 566, makeCastMap([Q$AutoBean, Q$AbstractAutoBean, Q$HasSplittable]), AssignmentProxyAutoBean_com_google_web_bindery_requestfactory_shared_impl_EntityProxyCategory_com_google_web_bindery_requestfactory_shared_impl_ValueProxyCategory_com_google_web_bindery_requestfactory_shared_impl_BaseProxyCategory_0, AssignmentProxyAutoBean_com_google_web_bindery_requestfactory_shared_impl_EntityProxyCategory_com_google_web_bindery_requestfactory_shared_impl_ValueProxyCategory_com_google_web_bindery_requestfactory_shared_impl_BaseProxyCategory_1);
_.as = function as_8(){
  return this.shim;
}
;
...
defineSeed(1055, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$AssignmentProxy]), AssignmentProxyAutoBean_com_google_web_bindery_requestfactory_shared_impl_EntityProxyCategory_com_google_web_bindery_requestfactory_shared_impl_ValueProxyCategory_com_google_web_bindery_requestfactory_shared_impl_BaseProxyCategory$1_0);
...
defineSeed(1078, 600, {}, AssignmentRequestFactoryImpl_0);
...
defineSeed(1079, 610, makeCastMap([Q$AbstractRequestContext]), AssignmentRequestFactory_AssignmentRequestContextImpl_0);
...
defineSeed(1080, 609, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$3X_0);
...
defineSeed(1081, 609, makeCastMap([Q$AbstractRequest]), AssignmentRequestFactory_AssignmentRequestContextImpl$8X_0);
...
defineSeed(1082, 538, makeCastMap([Q$EnumMap]), AssignmentRequestFactory_AssignmentRequestContextImpl_FactoryImpl_0);
...
defineSeed(1113, 609, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$2X_0);
...
defineSeed(1117, 609, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$7X_0);
