...
defineSeed(248, 239, {}, MouseDownEvent_0);
...
defineSeed(415, 416, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$FocusWidget, Q$Focusable, Q$HasFocus, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), Button_1);
...
defineSeed(419, 416, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$CheckBox, Q$FocusWidget, Q$Focusable, Q$HasFocus, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), CheckBox_2);
...
defineSeed(492, 423, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$HasVisibility, Q$HasWidgets, Q$IsWidget, Q$UIObject, Q$Widget, Q$Iterable]));
...
defineSeed(511, 490, makeCastMap([Q$HasAttachHandlers, Q$HasHandlers, Q$EventListener, Q$FocusWidget, Q$Focusable, Q$HasFocus, Q$HasVisibility, Q$IsWidget, Q$UIObject, Q$Widget]), TextArea_1);
...
defineSeed(751, 236, {}, LoadAllProfessorLogsEvent_0);
...
defineSeed(754, 236, {}, UpdateTimeLogEvent_0);
...
defineSeed(870, 693, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$ActionCompletedEvent$ActionCompletedHandler, Q$LoadAllProfessorLogsEvent$LoadAllProfessorLogsHandler, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$UpdateTimeLogEvent$UpdateTimeLogHandler, Q$TimeInputPresenter, Q$TimeInputUiHandler]), TimeInputPresenter_0);
...
defineSeed(871, 629, makeCastMap([Q$Receiver]), TimeInputPresenter$1_0);
...
defineSeed(872, 629, makeCastMap([Q$Receiver]), TimeInputPresenter$2_0);
...
defineSeed(873, 629, makeCastMap([Q$Receiver]), TimeInputPresenter$3_0);
...
defineSeed(874, 629, makeCastMap([Q$Receiver]), TimeInputPresenter$6_0);
...
defineSeed(875, 629, makeCastMap([Q$Receiver]), TimeInputPresenter$7_0);
...
defineSeed(876, 629, makeCastMap([Q$Receiver]), TimeInputPresenter$8_0);
...
defineSeed(877, 629, makeCastMap([Q$Receiver]), TimeInputPresenter$9_0);
...
defineSeed(879, 707, {}, TimeInputPresenterMyProxyImpl$1_0);
...
defineSeed(880, 1, {}, TimeInputPresenterMyProxyImpl$1$1_0);
...
defineSeed(885, 707, {}, TimeInputPresenterMyProxyImpl$4_0);
...
defineSeed(886, 1, {}, TimeInputPresenterMyProxyImpl$4$1_0);
...
function $createCheckBox(this$static, log_0, row, col, status_0){
  var cb;
  cb = new CheckBox_2;
  $setValue_0(cb, ($clinit_Boolean() , status_0?TRUE_1:FALSE_1));
...
defineSeed(1101, 698, makeCastMap([Q$IsWidget, Q$TimeInputPresenter$MyView]), TimeInputView_0);
...
defineSeed(1102, 383, makeCastMap([Q$HasCell, Q$Column]), TimeInputView$1_0);
...
defineSeed(1103, 383, makeCastMap([Q$HasCell, Q$Column]), TimeInputView$2_0);
...
defineSeed(1104, 557, makeCastMap([Q$HasHandlers]), TimeInputView$3_0);
...
defineSeed(1105, 1, makeCastMap([Q$EventHandler, Q$SelectionChangeEvent$Handler]), TimeInputView$4_0);
...
defineSeed(1106, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), TimeInputView$5_0);
...
defineSeed(1107, 1, makeCastMap([Q$CloseHandler, Q$EventHandler]), TimeInputView$6_0);
...
defineSeed(1108, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), TimeInputView$7_0);
_.onClick = function onClick_33(event_0){
  if (!$equals_3(this.this$0.selectedProfessor.getManagerName(), this.this$0.directorName)) {
    $setValue_0(dynamicCast(event_0.source, Q$CheckBox), ($clinit_Boolean() , $getValue_0(dynamicCast(event_0.source, Q$CheckBox)).value_0?FALSE_1:TRUE_1));
    return;
  }
...
defineSeed(1109, 1, {}, TimeInputView_BinderImpl_0);
...
defineSeed(1110, 1, {}, TimeInputView_BinderImpl$Widgets_0);
function TimeInputView_BinderImpl$Widgets$1_0(this$1){
  this.this$1 = this$1;
}

defineSeed(1111, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$1_0);
...
defineSeed(1112, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$10_0);
...
defineSeed(1113, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$11_0);
...
defineSeed(1114, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$12_0);
...
defineSeed(1115, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$13_0);
...
defineSeed(1116, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$14_0);
...
defineSeed(1117, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$15_0);
...
defineSeed(1118, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$16_0);
...
defineSeed(1119, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$17_0);
...
defineSeed(1120, 1, makeCastMap([Q$MouseDownHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$18_0);
...
defineSeed(1121, 1, makeCastMap([Q$MouseDownHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$19_0);
...
defineSeed(1122, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$2_0);
...
defineSeed(1123, 1, makeCastMap([Q$MouseDownHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$20_0);
...
defineSeed(1124, 1, makeCastMap([Q$MouseDownHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$21_0);
...
defineSeed(1125, 1, makeCastMap([Q$MouseDownHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$22_0);
...
defineSeed(1126, 1, makeCastMap([Q$MouseDownHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$23_0);
...
defineSeed(1127, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$3_0);
...
defineSeed(1128, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$4_0);
...
defineSeed(1129, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$5_0);
...
defineSeed(1130, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$6_0);
...
defineSeed(1131, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$7_0);
...
defineSeed(1132, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$8_0);
...
defineSeed(1133, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), TimeInputView_BinderImpl$Widgets$9_0);
...
defineSeed(1169, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$ProfessorProxy]));
...
;
defineSeed(1170, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$ProfessorProxy]));
...
defineSeed(1183, 624, {}, ContactRequestFactoryImpl_0);
...
defineSeed(1184, 634, makeCastMap([Q$AbstractRequestContext]), ContactRequestFactory_ContactRequestContextImpl_0);
...
defineSeed(1185, 633, makeCastMap([Q$AbstractRequest]), ContactRequestFactory_ContactRequestContextImpl$3X_0);
...
defineSeed(1186, 559, makeCastMap([Q$EnumMap]), ContactRequestFactory_ContactRequestContextImpl_FactoryImpl_0);
...
defineSeed(1204, 633, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$10X_0);
...
defineSeed(1206, 633, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$15X_0);
...
defineSeed(1207, 633, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$1X_0);
...
defineSeed(1208, 633, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$5X_0);
...
defineSeed(1223, 633, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$4X_0);
...
;
var Lcom_lemania_timetracking_client_presenter_TimeInputPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter', 870), Lcom_lemania_timetracking_client_presenter_TimeInputPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter$1', 871), Lcom_lemania_timetracking_client_presenter_TimeInputPresenter$2_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter$2', 872), Lcom_lemania_timetracking_client_presenter_TimeInputPresenter$3_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter$3', 873), Lcom_lemania_timetracking_client_presenter_TimeInputPresenter$6_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter$6', 874), Lcom_lemania_timetracking_client_presenter_TimeInputPresenter$7_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter$7', 875), Lcom_lemania_timetracking_client_presenter_TimeInputPresenter$8_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter$8', 876), Lcom_lemania_timetracking_client_presenter_TimeInputPresenter$9_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenter$9', 877), Lcom_lemania_timetracking_client_event_UpdateTimeLogEvent_2_classLit = createForClass('com.lemania.timetracking.client.event.', 'UpdateTimeLogEvent', 754), Lcom_lemania_timetracking_client_event_LoadAllProfessorLogsEvent_2_classLit = createForClass('com.lemania.timetracking.client.event.', 'LoadAllProfessorLogsEvent', 751), Lcom_lemania_timetracking_client_presenter_TimeInputPresenterMyProxyImpl$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenterMyProxyImpl$1', 879), Lcom_lemania_timetracking_client_presenter_TimeInputPresenterMyProxyImpl$1$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenterMyProxyImpl$1$1', 880), Lcom_lemania_timetracking_client_presenter_TimeInputPresenterMyProxyImpl$4_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenterMyProxyImpl$4', 885), Lcom_lemania_timetracking_client_presenter_TimeInputPresenterMyProxyImpl$4$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'TimeInputPresenterMyProxyImpl$4$1', 886), Lcom_lemania_timetracking_client_view_TimeInputView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView', 1101), Lcom_lemania_timetracking_client_view_TimeInputView$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView$1', 1102), Lcom_lemania_timetracking_client_view_TimeInputView$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView$2', 1103), Lcom_lemania_timetracking_client_view_TimeInputView$3_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView$3', 1104), Lcom_lemania_timetracking_client_view_TimeInputView$4_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView$4', 1105), Lcom_lemania_timetracking_client_view_TimeInputView$5_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView$5', 1106), Lcom_lemania_timetracking_client_view_TimeInputView$6_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView$6', 1107), Lcom_lemania_timetracking_client_view_TimeInputView$7_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView$7', 1108), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl', 1109), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets', 1110), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$1', 1111), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$2', 1122), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$3_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$3', 1127), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$4_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$4', 1128), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$5_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$5', 1129), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$6_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$6', 1130), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$7_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$7', 1131), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$8_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$8', 1132), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$9_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$9', 1133), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$10_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$10', 1112), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$11_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$11', 1113), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$12_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$12', 1114), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$13_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$13', 1115), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$14_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$14', 1116), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$15_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$15', 1117), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$16_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$16', 1118), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$17_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$17', 1119), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$18_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$18', 1120), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$19_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$19', 1121), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$20_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$20', 1123), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$21_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$21', 1124), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$22_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$22', 1125), Lcom_lemania_timetracking_client_view_TimeInputView_1BinderImpl$Widgets$23_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'TimeInputView_BinderImpl$Widgets$23', 1126), Lcom_lemania_timetracking_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$4X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$4X', 1223), Lcom_google_gwt_event_dom_client_MouseDownEvent_2_classLit = createForClass('com.google.gwt.event.dom.client.', 'MouseDownEvent', 248), Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$1X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'LogRequestFactory_LogRequestContextImpl$1X', 1207), Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$5X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'LogRequestFactory_LogRequestContextImpl$5X', 1208), Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$10X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'LogRequestFactory_LogRequestContextImpl$10X', 1204), Lcom_lemania_timetracking_shared_service_LogRequestFactory_1LogRequestContextImpl$15X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'LogRequestFactory_LogRequestContextImpl$15X', 1206), Lcom_google_gwt_user_client_ui_TextArea_2_classLit = createForClass('com.google.gwt.user.client.ui.', 'TextArea', 511), Lcom_lemania_timetracking_shared_service_ContactRequestFactoryImpl_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ContactRequestFactoryImpl', 1183), Lcom_lemania_timetracking_shared_service_ContactRequestFactory_1ContactRequestContextImpl_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl', 1184), Lcom_lemania_timetracking_shared_service_ContactRequestFactory_1ContactRequestContextImpl$3X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl$3X', 1185), Lcom_lemania_timetracking_shared_service_ContactRequestFactory_1ContactRequestContextImpl_1FactoryImpl_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ContactRequestFactory_ContactRequestContextImpl_FactoryImpl', 1186);
$entry(onLoad)(15);
