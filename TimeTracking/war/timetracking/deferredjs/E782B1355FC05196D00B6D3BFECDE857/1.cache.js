...
defineSeed(724, 663, makeCastMap([Q$HasHandlers, Q$PresenterWidget]), ContactPresenter_0);
...
defineSeed(886, 667, {}, ContactView_0);
...
defineSeed(887, 1, {}, ContactView_BinderImpl_0);
function $build_f_HTMLPanel1(this$static){
  ...
  $addAndReplaceElement(f_HTMLPanel1, (f_VerticalPanel2 = new VerticalPanel_0 , $add_8(f_VerticalPanel2, (f_Label3 = new Label_0 , f_Label3.element['className'] = 'pageTitle' , $setTextOrHtml(f_Label3.directionalTextHelper, 'Contact', false) , $updateHorizontalAlignment(f_Label3) , f_Label3)) , $add_8(f_VerticalPanel2, (f_HTML4 = new HTML_0 , $setHTML_0(f_HTML4, (sb = new StringBuilder_0 , sb.impl.string += 'Pour toutes questions, veuillez contacter Monsieur Carlo CAVADINI. <p>Email : Carlo.CAVADINI@lemania.ch <\/p> <p>Extension : 420<\/p>' , new OnlyToBeUsedInGeneratedCodeStringBlessedAsSafeHtml_0(sb.impl.string)).html) , f_HTML4.element['className'] = 'header' , f_HTML4.element.style['whiteSpace'] = ($clinit_Style$WhiteSpace() , 'normal') , f_HTML4)) , f_VerticalPanel2.element.style['width'] = '100%' , f_VerticalPanel2), $get_1(this$static.domId0Element));
  return f_HTMLPanel1;
}
...
defineSeed(888, 1, {}, ContactView_BinderImpl$Widgets_0);
_.domId0 = null;
