...
defineSeed(804, 663, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$RptTimeByDepartmentPresenter, Q$RptTimeByDepartmentUiHandler]), RptTimeByDepartmentPresenter_0);
...
defineSeed(805, 602, makeCastMap([Q$Receiver]), RptTimeByDepartmentPresenter$1_0);
...
defineSeed(806, 602, makeCastMap([Q$Receiver]), RptTimeByDepartmentPresenter$2_0);
...
defineSeed(988, 668, makeCastMap([Q$RptTimeByDepartmentPresenter$MyView, Q$RptTimeByDepartmentView]), RptTimeByDepartmentView_0);
...
defineSeed(989, 1, {}, RptTimeByDepartmentView_BinderImpl_0);
...
defineSeed(990, 1, {}, RptTimeByDepartmentView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(991, 1, makeCastMap([Q$ChangeHandler, Q$EventHandler]), RptTimeByDepartmentView_BinderImpl$Widgets$1_0);
...
defineSeed(1112, 606, makeCastMap([Q$AbstractRequest]), ProfessorRequestFactory_ProfessorRequestContextImpl$4X_0);
...
_.val$deptId = null;
_.val$year = 0;
var Lcom_lemania_timetracking_client_presenter_RptTimeByDepartmentPresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByDepartmentPresenter', 804), Lcom_lemania_timetracking_client_presenter_RptTimeByDepartmentPresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByDepartmentPresenter$1', 805), Lcom_lemania_timetracking_client_presenter_RptTimeByDepartmentPresenter$2_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'RptTimeByDepartmentPresenter$2', 806), Lcom_lemania_timetracking_client_view_RptTimeByDepartmentView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByDepartmentView', 988), Lcom_lemania_timetracking_client_view_RptTimeByDepartmentView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByDepartmentView_BinderImpl', 989), Lcom_lemania_timetracking_client_view_RptTimeByDepartmentView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByDepartmentView_BinderImpl$Widgets', 990), Lcom_lemania_timetracking_client_view_RptTimeByDepartmentView_1BinderImpl$Widgets$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'RptTimeByDepartmentView_BinderImpl$Widgets$1', 991), Lcom_lemania_timetracking_shared_service_ProfessorRequestFactory_1ProfessorRequestContextImpl$4X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'ProfessorRequestFactory_ProfessorRequestContextImpl$4X', 1112);
$entry(onLoad)(10);
