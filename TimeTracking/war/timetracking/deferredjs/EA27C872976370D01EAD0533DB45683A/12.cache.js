...
defineSeed(842, 688, makeCastMap([Q$HasHandlers, Q$PresenterWidget]), RptTimeBySchoolPresenter_0);
...
defineSeed(843, 627, makeCastMap([Q$Receiver]), RptTimeBySchoolPresenter$1_0);
...
defineSeed(1026, 693, makeCastMap([Q$RptTimeBySchoolPresenter$MyView, Q$RptTimeBySchoolView]), RptTimeBySchoolView_0);
...
defineSeed(1027, 395, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$1_0);
...
defineSeed(1028, 395, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$10_0);
...
defineSeed(1029, 395, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$11_0);
...
defineSeed(1030, 395, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$12_0);
...
defineSeed(1031, 395, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$13_0);
...
defineSeed(1032, 395, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$2_0);
...
defineSeed(1033, 395, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$3_0);
...
defineSeed(1034, 395, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$4_0);
...
defineSeed(1035, 395, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$5_0);
...
defineSeed(1036, 395, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$6_0);
...
defineSeed(1037, 395, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$7_0);
...
defineSeed(1038, 395, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$8_0);
...
defineSeed(1039, 395, makeCastMap([Q$HasCell, Q$Column]), RptTimeBySchoolView$9_0);
