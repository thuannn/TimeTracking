...
defineSeed(846, 688, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(847, 627, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(848, 627, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(849, 627, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1043, 693, makeCastMap([Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1153, 631, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
