...
defineSeed(741, 220, {}, LogTypeAddedEvent_0);
...
defineSeed(792, 688, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$HourAddUiHandler]), LogTypesAddPresenter_0);
...
defineSeed(793, 627, makeCastMap([Q$Receiver]), LogTypesAddPresenter$1_0);
...
;
_.this$0 = null;
defineSeed(801, 717, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$Place, Q$LogTypeAddedEvent$LogTypeAddedHandler]));
...
defineSeed(802, 701, {}, LogTypesPresenterMyProxyImpl$1_0);
...
defineSeed(803, 1, {}, LogTypesPresenterMyProxyImpl$1$1_0);
...
defineSeed(958, 693, makeCastMap([Q$LogTypesAddPresenter$MyView]), LogTypesAddView_0);
...
defineSeed(1139, 631, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$5X_0);
