...
defineSeed(796, 688, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LogTypeAddedEvent$LogTypeAddedHandler, Q$LogTypesPresenter, Q$LogTypeListUiHandler]), LogTypesPresenter_0);
...
defineSeed(797, 627, makeCastMap([Q$Receiver]), LogTypesPresenter$1_0);
...
defineSeed(798, 627, makeCastMap([Q$Receiver]), LogTypesPresenter$2_0);
...
defineSeed(799, 627, makeCastMap([Q$Receiver]), LogTypesPresenter$3_0);
...
defineSeed(800, 627, makeCastMap([Q$Receiver]), LogTypesPresenter$4_0);
...
defineSeed(964, 693, makeCastMap([Q$LogTypesPresenter$MyView]), LogTypesView_0);
...
defineSeed(965, 352, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$1_0);
...
defineSeed(967, 352, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$3_0);
...
defineSeed(969, 352, makeCastMap([Q$HasCell, Q$Column]), LogTypesView$5_0);
...
;
defineSeed(1097, 1, makeCastMap([Q$BaseProxy, Q$EntityProxy, Q$LogTypeProxy]));
...
defineSeed(1137, 631, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$2X_0);
...
defineSeed(1140, 631, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$6X_0);
