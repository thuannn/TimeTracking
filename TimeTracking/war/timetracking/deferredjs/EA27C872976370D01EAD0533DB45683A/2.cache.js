...
defineSeed(739, 220, {}, CoursAddedEvent_0);
...
defineSeed(752, 688, makeCastMap([Q$HasHandlers, Q$PresenterWidget, Q$CoursAddUiHandler]), CoursAddPresenter_0);
...
defineSeed(753, 627, makeCastMap([Q$Receiver]), CoursAddPresenter$1_0);
...
defineSeed(754, 627, makeCastMap([Q$Receiver]), CoursAddPresenter$2_0);
...
;
_.this$0 = null;
defineSeed(762, 717, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$Place, Q$CoursAddedEvent$CoursAddedHandler]));
...
defineSeed(763, 701, {}, CoursPresenterMyProxyImpl$1_0);
...
defineSeed(916, 693, makeCastMap([Q$CoursAddPresenter$MyView]), CoursAddView_0);
...
defineSeed(1115, 631, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$7X_0);
