...
defineSeed(757, 688, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$CoursAddedEvent$CoursAddedHandler, Q$CoursPresenter, Q$CoursListUiHandler]), CoursPresenter_0);
...
defineSeed(758, 627, makeCastMap([Q$Receiver]), CoursPresenter$1_0);
...
defineSeed(759, 627, makeCastMap([Q$Receiver]), CoursPresenter$2_0);
...
defineSeed(760, 627, makeCastMap([Q$Receiver]), CoursPresenter$3_0);
...
defineSeed(761, 627, makeCastMap([Q$Receiver]), CoursPresenter$4_0);
...
defineSeed(922, 693, makeCastMap([Q$CoursPresenter$MyView]), CoursView_0);
...
defineSeed(923, 352, makeCastMap([Q$HasCell, Q$Column]), CoursView$1_0);
...
defineSeed(925, 352, makeCastMap([Q$HasCell, Q$Column]), CoursView$3_0);
...
defineSeed(1116, 631, makeCastMap([Q$AbstractRequest]), CoursRequestFactory_CoursRequestContextImpl$8X_0);
