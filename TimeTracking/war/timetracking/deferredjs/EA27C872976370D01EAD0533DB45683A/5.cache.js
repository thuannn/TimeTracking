...
defineSeed(770, 688, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$EcoleAddedEvent$EcoleAddedHandler, Q$EcolePresenter, Q$EcoleListUiHandler]), EcolePresenter_0);
...
defineSeed(771, 627, makeCastMap([Q$Receiver]), EcolePresenter$1_0);
...
defineSeed(772, 627, makeCastMap([Q$Receiver]), EcolePresenter$2_0);
...
defineSeed(937, 693, makeCastMap([Q$EcolePresenter$MyView]), EcoleView_0);
...
defineSeed(938, 395, makeCastMap([Q$HasCell, Q$Column]), EcoleView$1_0);
...
defineSeed(939, 395, makeCastMap([Q$HasCell, Q$Column]), EcoleView$2_0);
...
defineSeed(940, 352, makeCastMap([Q$HasCell, Q$Column]), EcoleView$3_0);
...
defineSeed(1123, 631, makeCastMap([Q$AbstractRequest]), EcoleRequestFactory_EcoleRequestContextImpl$6X_0);
...
;
_.val$newEcole = null;
var Lcom_lemania_timetracking_client_presenter_EcolePresenter_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcolePresenter', 770), Lcom_lemania_timetracking_client_presenter_EcolePresenter$1_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcolePresenter$1', 771), Lcom_lemania_timetracking_client_presenter_EcolePresenter$2_2_classLit = createForClass('com.lemania.timetracking.client.presenter.', 'EcolePresenter$2', 772), Lcom_lemania_timetracking_client_view_EcoleView_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleView', 937), Lcom_lemania_timetracking_client_view_EcoleView$1_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleView$1', 938), Lcom_lemania_timetracking_client_view_EcoleView$2_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleView$2', 939), Lcom_lemania_timetracking_client_view_EcoleView$3_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleView$3', 940), Lcom_lemania_timetracking_client_view_EcoleView$4_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleView$4', 941), Lcom_lemania_timetracking_client_view_EcoleView_1BinderImpl_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleView_BinderImpl', 942), Lcom_lemania_timetracking_client_view_EcoleView_1BinderImpl$Widgets_2_classLit = createForClass('com.lemania.timetracking.client.view.', 'EcoleView_BinderImpl$Widgets', 943), Lcom_lemania_timetracking_shared_service_EcoleRequestFactory_1EcoleRequestContextImpl$6X_2_classLit = createForClass('com.lemania.timetracking.shared.service.', 'EcoleRequestFactory_EcoleRequestContextImpl$6X', 1123);
$entry(onLoad)(5);
