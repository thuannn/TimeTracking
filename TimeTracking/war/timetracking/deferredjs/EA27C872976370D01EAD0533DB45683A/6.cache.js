...
defineSeed(777, 688, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$PresenterWidget, Q$LoginAuthenticatedEvent$LoginAuthenticatedHandler, Q$ExtractDataPresenter, Q$ExtractDataUiHandler]), ExtractDataPresenter_0);
...
defineSeed(778, 627, makeCastMap([Q$Receiver]), ExtractDataPresenter$1_0);
...
defineSeed(779, 627, makeCastMap([Q$Receiver]), ExtractDataPresenter$2_0);
...
defineSeed(780, 627, makeCastMap([Q$Receiver]), ExtractDataPresenter$3_0);
...
defineSeed(945, 693, makeCastMap([Q$ExtractDataPresenter$MyView, Q$ExtractDataView]), ExtractDataView_0);
...
defineSeed(1133, 631, makeCastMap([Q$AbstractRequest]), LogRequestFactory_LogRequestContextImpl$8X_0);
