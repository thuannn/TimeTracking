...
function $updateLogTypeStatus(this$static, hp, status_0){
  ...
  $fire((x = new LogTypeRequestFactory_LogTypeRequestContextImpl$5X_0(rc, hourForUpdate) , $addInvocation(rc.state.dialect, x) , x), new LogTypesPresenter$2_0(this$static));
}
...
_ = LogTypesPresenter_0.prototype = LogTypesPresenter.prototype;
...
_.onReset = function onReset_3(){
  ...
  rc = new LogTypeRequestFactory_LogTypeRequestContextImpl_0(rf);
  $fire((x = new LogTypeRequestFactory_LogTypeRequestContextImpl$1X_0(rc) , $addInvocation(rc.state.dialect, x) , x), new LogTypesPresenter$1_0(this));
}
;
...
;
_.getValue = function getValue_14(type){
...
;
function LogTypeRequestFactory_LogTypeRequestContextImpl$1X_0(this$0){
  AbstractRequest_0.call(this, this$0);
}

function LogTypeRequestFactory_LogTypeRequestContextImpl$1X(){
}

_ = LogTypeRequestFactory_LogTypeRequestContextImpl$1X_0.prototype = LogTypeRequestFactory_LogTypeRequestContextImpl$1X.prototype = new AbstractRequest;
_.getClass$ = function getClass_758(){
  return Lcom_lemania_timetracking_shared_service_LogTypeRequestFactory_1LogTypeRequestContextImpl$1X_2_classLit;
}
;
...
function LogTypeRequestFactory_LogTypeRequestContextImpl$5X_0(this$0, val$newHour){
  this.val$newHour = val$newHour;
  AbstractRequest_0.call(this, this$0);
}

function LogTypeRequestFactory_LogTypeRequestContextImpl$5X(){
}

_ = LogTypeRequestFactory_LogTypeRequestContextImpl$5X_0.prototype = LogTypeRequestFactory_LogTypeRequestContextImpl$5X.prototype = new AbstractRequest;
_.getClass$ = function getClass_761(){
  return Lcom_lemania_timetracking_shared_service_LogTypeRequestFactory_1LogTypeRequestContextImpl$5X_2_classLit;
}
;
