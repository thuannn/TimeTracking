...
defineSeed(834, 663, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$SettingOptionsUiHandler]), SettingsPresenter_0);
...
defineSeed(835, 602, makeCastMap([Q$Receiver]), SettingsPresenter$1_0);
...
defineSeed(836, 602, makeCastMap([Q$Receiver]), SettingsPresenter$2_0);
...
defineSeed(837, 602, makeCastMap([Q$Receiver]), SettingsPresenter$3_0);
...
defineSeed(1039, 668, makeCastMap([Q$IsWidget, Q$SettingsPresenter$MyView, Q$SettingsView]), SettingsView_0);
...
defineSeed(1146, 606, makeCastMap([Q$AbstractRequest]), SettingOptionRequestFactory_SettingOptionRequestContextImpl$4X_0);
