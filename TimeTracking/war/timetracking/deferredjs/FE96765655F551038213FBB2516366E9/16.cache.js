...
defineSeed(724, 229, {}, LogTypeAddedEvent_0);
...
defineSeed(773, 666, makeCastMap([Q$HasHandlers, Q$IsWidget, Q$PresenterWidget, Q$HourAddUiHandler]), LogTypesAddPresenter_0);
...
defineSeed(774, 605, makeCastMap([Q$Receiver]), LogTypesAddPresenter$1_0);
...
;
_.this$0 = null;
defineSeed(782, 698, makeCastMap([Q$EventHandler, Q$HasHandlers, Q$DelayedBind, Q$HasHandlerContainer, Q$Place, Q$LogTypeAddedEvent$LogTypeAddedHandler]));
...
defineSeed(783, 680, {}, LogTypesPresenterMyProxyImpl$1_0);
...
defineSeed(947, 671, makeCastMap([Q$IsWidget, Q$LogTypesAddPresenter$MyView]), LogTypesAddView_0);
...
defineSeed(948, 1, {}, LogTypesAddView_BinderImpl_0);
...
defineSeed(949, 1, {}, LogTypesAddView_BinderImpl$Widgets_0);
_.domId0 = null;
...
defineSeed(950, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), LogTypesAddView_BinderImpl$Widgets$1_0);
...
defineSeed(951, 1, makeCastMap([Q$ClickHandler, Q$EventHandler]), LogTypesAddView_BinderImpl$Widgets$2_0);
...
defineSeed(1146, 609, makeCastMap([Q$AbstractRequest]), LogTypeRequestFactory_LogTypeRequestContextImpl$5X_0);
